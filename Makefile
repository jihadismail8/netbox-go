...
.PHONY: check backend-check frontend-check generated-check contracts-check docs-check frontend-install source-digest deployment-smoke deployment-image-smoke browser-e2e compatibility-test compatibility-comparator-test
...
# Produce a stable identifier for the owned source used by a retained evidence
# bundle. The pinned upstream oracle is recorded separately by Git SHA.
source-digest:
