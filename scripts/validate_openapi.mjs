...
const contractedResourceShapes = {
  ...
  Rack: {
    request: {
      site: { type: "integer", format: "int64" },
      name: { type: "string" },
      facility_id: { type: "string" },
      rack_type: { type: "integer", format: "int64" },
      role: { type: "integer", format: "int64" },
      serial: { type: "string" },
    ...
    responseReferences: {
      site: "#/components/schemas/ObjectReference",
      rack_type: "#/components/schemas/ObjectReference",
  ...
  DeviceRole: {
    ...
    response: {
      ...
      last_updated: { type: "string", format: "date-time" },
      device_count: { type: "integer", format: "int64" },
      _depth: { type: "integer", format: "int64" },
    },
    responseReferences: {
  ...
  DeviceType: {
    request: {
      ...
      u_height: { type: "number", format: "double" },
      exclude_from_utilization: { type: "boolean" },
    ...
    response: {
      ...
      last_updated: { type: "string", format: "date-time" },
      device_count: { type: "integer", format: "int64" },
      interface_template_count: { type: "integer", format: "int64" },
    },
    responseReferences: {
      manufacturer: "#/components/schemas/ObjectReference",
    },
