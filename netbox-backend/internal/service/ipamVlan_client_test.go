...
// Test_service_ipamVlan_methods is used to test the ipamVlan api
// Test_service_ipamVlan_benchmark is used to performance test the ipamVlan api
...
// Test service ipamVlan api via grpc client
func Test_service_ipamVlan_methods(t *testing.T) {
	conn := getRPCClientConnForTest()
	cli := netbox_goV1.NewIpamVlanClient(conn)
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &netbox_goV1.CreateIpamVlanRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Vid:             0,
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamVlanByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.UpdateIpamVlanByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamVlanByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamVlanRequest{
					Params: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamVlanByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamVlanByConditionRequest{
					Conditions: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamVlanByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamVlanByLastIDRequest{
					LastID: 0,  // last id
...
// performance test service ipamVlan api, copy the report to
// the browser to view when the pressure test is finished.
func Test_service_ipamVlan_benchmark(t *testing.T) {
	...
	protoFile := configs.Path("../api/netbox_go/v1/ipamVlan.proto")
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				...
				message := &netbox_goV1.CreateIpamVlanRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Vid:             0,
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamVlanByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.UpdateIpamVlanByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamVlanByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamVlanRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamVlanByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamVlanByConditionRequest{
					Conditions: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamVlanByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamVlanByLastIDRequest{
					LastID: 0,  // last id
					Limit:  0,  // limit size per page
					Sort:   "", // sort by column name of table, default is -id, the - sign indicates descending order.
				}
