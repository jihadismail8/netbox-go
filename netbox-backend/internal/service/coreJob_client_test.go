...
// Test_service_coreJob_methods is used to test the coreJob api
// Test_service_coreJob_benchmark is used to performance test the coreJob api
...
// Test service coreJob api via grpc client
func Test_service_coreJob_methods(t *testing.T) {
	conn := getRPCClientConnForTest()
	cli := netbox_goV1.NewCoreJobClient(conn)
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &netbox_goV1.CreateCoreJobRequest{
					ObjectID:     0,
					Name:         "",
					Created:      "",
					Scheduled:    "",
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteCoreJobByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.UpdateCoreJobByIDRequest{
					Id:           0,
					ObjectID:     0,
					Name:         "",
					Created:      "",
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetCoreJobByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListCoreJobRequest{
					Params: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteCoreJobByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetCoreJobByConditionRequest{
					Conditions: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListCoreJobByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListCoreJobByLastIDRequest{
					LastID: 0,  // last id
...
// performance test service coreJob api, copy the report to
// the browser to view when the pressure test is finished.
func Test_service_coreJob_benchmark(t *testing.T) {
	...
	protoFile := configs.Path("../api/netbox_go/v1/coreJob.proto")
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				...
				message := &netbox_goV1.CreateCoreJobRequest{
					ObjectID:     0,
					Name:         "",
					Created:      "",
					Scheduled:    "",
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteCoreJobByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.UpdateCoreJobByIDRequest{
					Id:           0,
					ObjectID:     0,
					Name:         "",
					Created:      "",
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetCoreJobByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListCoreJobRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteCoreJobByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetCoreJobByConditionRequest{
					Conditions: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListCoreJobByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListCoreJobByLastIDRequest{
					LastID: 0,  // last id
					Limit:  0,  // limit size per page
					Sort:   "", // sort by column name of table, default is -id, the - sign indicates descending order.
				}
