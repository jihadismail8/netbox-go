...
// Test_service_ipamAsn_methods is used to test the ipamAsn api
// Test_service_ipamAsn_benchmark is used to performance test the ipamAsn api
...
// Test service ipamAsn api via grpc client
func Test_service_ipamAsn_methods(t *testing.T) {
	conn := getRPCClientConnForTest()
	cli := netbox_goV1.NewIpamAsnClient(conn)
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &netbox_goV1.CreateIpamAsnRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Asn:             0,
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamAsnByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.UpdateIpamAsnByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamAsnByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamAsnRequest{
					Params: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamAsnByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamAsnByConditionRequest{
					Conditions: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamAsnByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamAsnByLastIDRequest{
					LastID: 0,  // last id
...
// performance test service ipamAsn api, copy the report to
// the browser to view when the pressure test is finished.
func Test_service_ipamAsn_benchmark(t *testing.T) {
	...
	protoFile := configs.Path("../api/netbox_go/v1/ipamAsn.proto")
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				...
				message := &netbox_goV1.CreateIpamAsnRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Asn:             0,
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamAsnByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.UpdateIpamAsnByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamAsnByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamAsnRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamAsnByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamAsnByConditionRequest{
					Conditions: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamAsnByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamAsnByLastIDRequest{
					LastID: 0,  // last id
					Limit:  0,  // limit size per page
					Sort:   "", // sort by column name of table, default is -id, the - sign indicates descending order.
				}
