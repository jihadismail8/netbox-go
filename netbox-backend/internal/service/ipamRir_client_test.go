...
// Test_service_ipamRir_methods is used to test the ipamRir api
// Test_service_ipamRir_benchmark is used to performance test the ipamRir api
...
// Test service ipamRir api via grpc client
func Test_service_ipamRir_methods(t *testing.T) {
	conn := getRPCClientConnForTest()
	cli := netbox_goV1.NewIpamRirClient(conn)
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &netbox_goV1.CreateIpamRirRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Name:            "",
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamRirByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.UpdateIpamRirByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamRirByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamRirRequest{
					Params: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteIpamRirByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetIpamRirByConditionRequest{
					Conditions: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamRirByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListIpamRirByLastIDRequest{
					LastID: 0,  // last id
...
// performance test service ipamRir api, copy the report to
// the browser to view when the pressure test is finished.
func Test_service_ipamRir_benchmark(t *testing.T) {
	...
	protoFile := configs.Path("../api/netbox_go/v1/ipamRir.proto")
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				...
				message := &netbox_goV1.CreateIpamRirRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Name:            "",
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamRirByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.UpdateIpamRirByIDRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Id:              0,
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamRirByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamRirRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteIpamRirByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetIpamRirByConditionRequest{
					Conditions: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamRirByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListIpamRirByLastIDRequest{
					LastID: 0,  // last id
					Limit:  0,  // limit size per page
					Sort:   "", // sort by column name of table, default is -id, the - sign indicates descending order.
				}
