...
// Test_service_vpnL2Vpn_methods is used to test the vpnL2Vpn api
// Test_service_vpnL2Vpn_benchmark is used to performance test the vpnL2Vpn api
...
// Test service vpnL2Vpn api via grpc client
func Test_service_vpnL2Vpn_methods(t *testing.T) {
	conn := getRPCClientConnForTest()
	cli := netbox_goV1.NewVpnL2VpnClient(conn)
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &netbox_goV1.CreateVpnL2VpnRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Name:            "",
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteVpnL2VpnByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.UpdateVpnL2VpnByIDRequest{
					Id:              0,
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetVpnL2VpnByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListVpnL2VpnRequest{
					Params: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.DeleteVpnL2VpnByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.GetVpnL2VpnByConditionRequest{
					Conditions: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListVpnL2VpnByIDsRequest{
					Ids: nil,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &netbox_goV1.ListVpnL2VpnByLastIDRequest{
					LastID: 0,  // last id
...
// performance test service vpnL2Vpn api, copy the report to
// the browser to view when the pressure test is finished.
func Test_service_vpnL2Vpn_benchmark(t *testing.T) {
	...
	protoFile := configs.Path("../api/netbox_go/v1/vpnL2Vpn.proto")
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				...
				message := &netbox_goV1.CreateVpnL2VpnRequest{
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
					Name:            "",
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteVpnL2VpnByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.UpdateVpnL2VpnByIDRequest{
					Id:              0,
					Created:         "",
					LastUpdated:     "",
					CustomFieldData: "",
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetVpnL2VpnByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListVpnL2VpnRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.DeleteVpnL2VpnByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.GetVpnL2VpnByConditionRequest{
					Conditions: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListVpnL2VpnByIDsRequest{
					Ids: nil,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &netbox_goV1.ListVpnL2VpnByLastIDRequest{
					LastID: 0,  // last id
					Limit:  0,  // limit size per page
					Sort:   "", // sort by column name of table, default is -id, the - sign indicates descending order.
				}
