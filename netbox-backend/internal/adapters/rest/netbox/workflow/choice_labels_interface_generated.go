// Code generated from the pinned NetBox v4.4.6 InterfaceTypeChoices; DO NOT EDIT.
// This compiled lookup has no runtime or build dependency on Python or NetBox.
package workflow

var interfaceTypeResponseLabels = map[string]string{
	"virtual":                 "Virtual",
	"bridge":                  "Bridge",
