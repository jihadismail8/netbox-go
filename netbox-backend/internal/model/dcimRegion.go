...
func (m *DcimRegion) TableName() string {
	return "dcim_region"
}

// DcimRegionColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimRegionColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
