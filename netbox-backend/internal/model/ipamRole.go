...
func (m *IpamRole) TableName() string {
	return "ipam_role"
}

// IpamRoleColumnNames Whitelist for custom query fields to prevent sql injection attacks
var IpamRoleColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
