...
func (m *DcimConsoleserverport) TableName() string {
	return "dcim_consoleserverport"
}

// DcimConsoleserverportColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimConsoleserverportColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
