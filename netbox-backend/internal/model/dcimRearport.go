...
func (m *DcimRearport) TableName() string {
	return "dcim_rearport"
}

// DcimRearportColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimRearportColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
