...
func (m *DcimConsoleserverporttemplate) TableName() string {
	return "dcim_consoleserverporttemplate"
}

// DcimConsoleserverporttemplateColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimConsoleserverporttemplateColumnNames = map[string]bool{
	"created":        true,
	"last_updated":   true,
	"id":             true,
	"name":           true,
