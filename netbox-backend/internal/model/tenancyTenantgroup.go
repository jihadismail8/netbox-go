...
func (m *TenancyTenantgroup) TableName() string {
	return "tenancy_tenantgroup"
}

// TenancyTenantgroupColumnNames Whitelist for custom query fields to prevent sql injection attacks
var TenancyTenantgroupColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
