...
func (m *VpnTunnelgroup) TableName() string {
	return "vpn_tunnelgroup"
}

// VpnTunnelgroupColumnNames Whitelist for custom query fields to prevent sql injection attacks
var VpnTunnelgroupColumnNames = map[string]bool{
	"id":                true,
	"created":           true,
	"last_updated":      true,
