...
func (m *CircuitsCircuitgroup) TableName() string {
	return "circuits_circuitgroup"
}

// CircuitsCircuitgroupColumnNames Whitelist for custom query fields to prevent sql injection attacks
var CircuitsCircuitgroupColumnNames = map[string]bool{
	"id":                true,
	"created":           true,
	"last_updated":      true,
