...
func (m *TenancyContactgroup) TableName() string {
	return "tenancy_contactgroup"
}

// TenancyContactgroupColumnNames Whitelist for custom query fields to prevent sql injection attacks
var TenancyContactgroupColumnNames = map[string]bool{
	"id":                true,
	"created":           true,
	"last_updated":      true,
