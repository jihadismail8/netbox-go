...
func (m *DcimSitegroup) TableName() string {
	return "dcim_sitegroup"
}

// DcimSitegroupColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimSitegroupColumnNames = map[string]bool{
	"created":           true,
	"last_updated":      true,
