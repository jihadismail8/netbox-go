...
func (m *ExtrasBookmark) TableName() string {
	return "extras_bookmark"
}

// ExtrasBookmarkColumnNames Whitelist for custom query fields to prevent sql injection attacks
var ExtrasBookmarkColumnNames = map[string]bool{
	"id":             true,
	"created":        true,
	"object_id":      true,
	"object_type_id": true,
