...
func (m *DcimFrontport) TableName() string {
	return "dcim_frontport"
}

// DcimFrontportColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimFrontportColumnNames = map[string]bool{
	"created":            true,
	"last_updated":       true,
