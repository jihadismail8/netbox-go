...
func (m *DcimConsoleporttemplate) TableName() string {
	return "dcim_consoleporttemplate"
}

// DcimConsoleporttemplateColumnNames Whitelist for custom query fields to prevent sql injection attacks
var DcimConsoleporttemplateColumnNames = map[string]bool{
	"created":        true,
	"last_updated":   true,
	"id":             true,
	"name":           true,
