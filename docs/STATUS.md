...
bearer parsing, and fail-closed unary method safety. Its parent and the session,
CSRF, throttle, trusted-proxy,
...
| V1 identity/RBAC         | Persisted identity, retained CORS, accepted bounded token lookup/touch and token-transport evidence | Complete session/CSRF/throttle/proxy/streaming plus RBAC/admin/secret work                                      | V1-01/I1/I2 done; parent active       |
