# Core Workflow InterfaceTemplate scalar write presence — 2026-08-25
...
This artifact proves only `dcim.InterfaceTemplate` common writable-field
create/PUT/PATCH presence for `device_type`, `name`, `label`, `type`,
`enabled`, `mgmt_only`, and `description`, as bounded by the reviewed
[`CW1-V2-02-I8` packet](../increments/CW1-V2-02-I8.md).

It does not complete InterfaceTemplate resource/list/get/delete behavior,
DeviceType/name uniqueness, owner-immutability traceability, Device
instantiation or rollback, non-retroactivity, bridge/PoE/RF behavior,
ModuleType ownership, `CW1-V2-02`, V2, any compatibility tier, profile state,
traceability consumer, deployment, publication, the rewrite, or production
readiness.
...
- Entry revision:
  `fe29f09f5c393d31dc465141d0be04c8df6141f5`.
- Entry source digest:
  `source-v2:sha256:c126273c49d125e0fef75ee1409455f69ddd7b4cb48a68ff6450dd824fa19604`
  with 3,057 entries.
- Entry source-manifest output SHA-256:
  `e0c8722a8dc1f33d9ee2c14e9cc0746bd9983e10b40575a322b4479c8eccccde`.
- Reviewed packet revision:
  `9208fceecb33a8f7ae9e7ff932276a87874ab023`.
- Reviewed packet CI: run
  [32878033503](https://github.com/jihadismail8/netbox-go/actions/runs/32878033503),
  job
  [97900628486](https://github.com/jihadismail8/netbox-go/actions/runs/32878033503/job/97900628486),
  with job success from `2026-08-25T17:27:58Z` through
  `2026-08-25T17:48:29Z`.
- Tested source candidate:
  `b216d4c217cf863a8760494fd6499e54899ef368`.
- Tested source digest:
  `source-v2:sha256:da2b93d51dbdc2dfbcb6e348e2f5b23f42439b5973169f683ddc39de285c5048`.
- Tested owned entries: 3,064.
...
- Complete derived source-manifest diff SHA-256:
  `7bc77bbb826acd49324ca7d675e69e114b098db321fc869822333ca632321738`.
...
Three implementation slices used disjoint closed-file scopes, and three
read-only cross-reviews found no remaining issue. The preserved
...
- Operation metadata generates distinct `InterfaceTemplateCreate`,
  `InterfaceTemplateReplace`, and `InterfaceTemplateUpdate` request schemas.
  Create and replace require `device_type`, `name`, and `type`; update requires
  no field. All seven request fields are non-null. Only label and description
  accept blank. Responses use a non-null DeviceType `ObjectReference`, a
  non-null choice envelope for type, and nullable creation/update timestamps.
- POST defaults label and description to `""`, enabled to `true`, and
  management-only to `false`. PUT requires the identity triplet while
  preserving omitted label, enabled, management-only, and description. PATCH
  preserves every omission. Explicit null rejects for all seven fields;
  blank label/description clear, and explicit false persists.
- DeviceType input stays within the positive numeric-ID envelope. The current
  owner must be repeated on PUT; omitted PATCH ownership preserves it, and a
  known different owner rejects. I8 exercises this existing containment but
  does not close owner-immutability traceability.
- Name, label, and description use pinned whitespace trimming and Unicode
  length limits. Type accepts the exact untrimmed 206-value pinned choice set.
  Combined violations are deterministic and preserve valid sibling intent.
- The shared application transaction owns relationship resolution,
  ...
  typed InterfaceTemplate object change. Validation and recorder failures
  preserve aggregate, raw row, timestamp, repository, and audit state.
- REST preserves omitted, null, blank, zero, false, and concrete intent.
  Supported gRPC update-mask paths with absent optional values become explicit
  null intent and reach the same application validation; unknown paths fail
  closed. No protobuf was changed or regenerated.
- Real PostgreSQL reloads normalized scalar and relationship state, proves
  exact change deltas and rollback, and retains zero Device/Interface rows.
  Existing row/repository/schema code required no production change.
- Vue uses nullable response timestamps, numeric DeviceType IDs, a private
  normalized edit baseline, `{}` for unchanged edits, and exact one-field
  deltas while preserving blank, false, null, and concrete intent.
- Traceability adds one unresolved InterfaceTemplate scalar-presence
  assessment and remaps exactly create, replace, and update. Every other
  InterfaceTemplate row, verification set, tier, consumer, and parent remains
  open.

## Changed tested-source files

The candidate differs from the accepted I7 entry across exactly 30 regular
mode-`100644` paths, with 3,541 insertions and 197 deletions:
...
5. `docs/STATUS.md`
6. `docs/TESTING.md`
7. `docs/increments/CW1-V2-02-I7.md`
8. `docs/increments/CW1-V2-02-I8.md` — new
9. `docs/increments/README.md`
10. `netbox-backend/api/openapi/netbox-go-v1.yaml`
11. `netbox-backend/internal/adapters/grpc/workflow/interface_template_typed_handler.go`
12. `netbox-backend/internal/adapters/grpc/workflow/interface_template_typed_handler_test.go`
13. `netbox-backend/internal/adapters/grpc/workflow/interface_template_typed_mapper_test.go` — new
14. `netbox-backend/internal/adapters/postgres/dcim/interface_template_service_real_postgres_test.go` — new
15. `netbox-backend/internal/adapters/rest/netbox/workflow/interface_template_scalar_presence_test.go` — new
16. `netbox-backend/internal/application/dcim/interface_template_commands.go`
17. `netbox-backend/internal/application/dcim/interface_template_commands_test.go` — new
18. `netbox-backend/internal/application/dcim/interface_template_service.go`
19. `netbox-backend/internal/application/dcim/interface_template_service_presence_test.go` — new
20. `netbox-backend/internal/application/dcim/interface_template_service_test.go`
21. `netbox-backend/internal/domain/dcim/interface_template.go`
22. `netbox-backend/internal/domain/dcim/interface_template_test.go`
23. `netbox-backend/test/parity/interface_template_scalar_presence_test.go` — new
...
The seven entry-governance paths only record effective I7 closeout and active
I8 scope; they change no I7 behavior.
...
```text
TestInterfaceTemplateScalarNormalizationContract
TestInterfaceTemplateScalarCommandPresenceMatrix
TestReplaceInterfaceTemplatePreservesOmittedState
TestInterfaceTemplateScalarValidationLeavesStateUnchanged
TestInterfaceTemplateRESTScalarPresenceMatrix
TestInterfaceTemplateGRPCScalarPresenceMatrix
...
PostgreSQL/transport tests found no issue. The current pre-I8 PUT path's
optional-field reset was reproduced and corrected. No test, comparator,
normalizer, security control, lint rule, coverage floor, generated check, or
evidence requirement was weakened.

## Focused, race, PostgreSQL, and full-L4 results

An exact committed, timestamped focused replay found the eight tests once each
and passed the exact fixed-test command, affected non-PostgreSQL packages, and
their combined race-enabled replay. The exact committed root gate then
replayed every hermetic backend package under `-race -short -count=1`.
The focused replay ran from `2026-08-25T18:48:42Z` through
`2026-08-25T18:51:54Z`, exited 0, completed parity in 14.163 seconds without
race instrumentation and 176.260 seconds with it, and has SHA-256
`8956974d32e4b78bd0cbe1eec434a23ad132a9a0c181114091b1f552bc3fc52c`.

The exact committed real-PostgreSQL session ran from
`2026-08-25T18:22:07Z` through `2026-08-25T18:22:44Z` and exited 0. The focused
durability test passed without skip in 0.283 seconds, including every named
success, rejection, owner, and recorder-rollback case.

The same unchanged session passed complete L4:

| Package                                | Result  |
| -------------------------------------- | ------: |
| `internal/database`                    |  2.374s |
| `internal/adapters/postgres/bootstrap` |  0.039s |
| `internal/adapters/postgres/dcim`      |  3.149s |
| `internal/adapters/postgres/dcim/row`  |  0.324s |
| `internal/adapters/postgres/ipam`      |  1.698s |
| `internal/adapters/postgres/ipam/row`  |  0.401s |
| `internal/adapters/postgres/changelog` |  0.003s |
| `internal/application/dcim`            |  0.004s |
| `internal/application/ipam`            |  0.065s |
| `internal/application/identity`        | 34.517s |
| `cmd/netbox_go_admin`                  |  6.582s |

The run used exact disposable database and role `netbox_i8_20260825` in the
existing local PostgreSQL container. A random credential lived only in the
test process. An exit trap terminated connections and removed the database and
role; an independent post-run query returned no matching object. No credential
or complete DSN is retained, and the disposable data is not recoverable.
The timestamped `0|0` cleanup-verification log has SHA-256
`55e430047bfb9f65dab33847e990cf954353723891138ce94c1462dfb91b1481`.
...
- all 185 capability-profile/OpenAPI adversarial tests;
...
- inventory at 155 baseline REST, 123 current REST, 179 current gRPC, and 13
  current Vue entries;
- 53 focused Vue adapter/form tests plus production and test typechecks; and
- the complete frontend gate: 29 files and 173 tests, 64.3% statement/line,
  81.28% branch, and 66.13% function coverage, formatting, lint, typechecks,
...
changes are outside I8 and no finding is represented as resolved.

## Whole-repository result

The exact committed candidate passed this pinned command from
`2026-08-25T18:23:58Z` through `2026-08-25T18:29:11Z` with exit 0:
...
- all hermetic backend packages under the race detector, including parity in
  183.399 seconds;
- backend coverage at 12.9282% (37,689/291,526), above the retained 12.4001%
...
- every contract, profile, frontend, generated, inventory, and link result
  above; and
- 173 Markdown files with valid local links.

The exact committed log has SHA-256
`7200b6ab9f2beced0f8a9828ff776725fbbab090df5ec72a94c70b31ad20e45a`.
The exact committed PostgreSQL/L4 log has SHA-256
`f3e7de958ec3dfeabc190854b3e65fae614e8d6c8199ba917193d44c730aa216`.
Both retained logs passed a credential/DSN/header pattern scan. Temporary log
paths are diagnostic provenance only; the durable result is this committed
summary plus exact candidate CI.

Final source digest and complete manifest confirmation ran from
`2026-08-25T18:30:33Z` through `2026-08-25T18:30:34Z`. The digest, 3,064-entry
manifest, and canonical manifest-output hash remained byte-identical across
commit and push.
...
- Head SHA: `b216d4c217cf863a8760494fd6499e54899ef368`.
- Run start/completion: `2026-08-25T18:31:07Z`–`2026-08-25T18:47:47Z`.
- Job start/completion: `2026-08-25T18:31:10Z`–`2026-08-25T18:47:47Z`.
...
`b216d4c217cf863a8760494fd6499e54899ef368`, not a merge revision or later
behavior source.

## Digest-excluded claim local gate

The evidence assembly changes only the two source-v2-excluded paths listed
below. It reproduces the tested digest, 3,064-entry manifest, canonical
manifest-output hash, and empty derived diff exactly.

The assembly passed the pinned full repository gate from
`2026-08-25T18:57:35Z` through `2026-08-25T19:02:56Z` with exit 0. It retained
zero backend lint issues, coverage above the unchanged floor, all backend
race/coverage checks, 96 traceability tests, 185 capability/OpenAPI
adversarial tests, 29 frontend files and 173 frontend tests, generated and
inventory checks, the `13/3/17/293` profile boundary, `33/86` OpenAPI shape,
and valid local links across 174 Markdown files. Its credential-free log has
SHA-256
`af004bc302c6aff2b8c98fdddec3b5840496acb8053973f342021a52012698d8`.
...
neither result proves InterfaceTemplate's complete presence matrix against the
pinned NetBox runtime. No local adapter/parity/PostgreSQL test substitutes for
that boundary. REST T2 and corresponding gRPC T3 remain unearned; Vue
unit/type tests earn no browser T4.

Numeric-string or nested-object DeviceType input, malformed generic payloads,
empty PATCH, uniqueness/races, owner-immutability closure, ModuleType owners,
instantiation/non-retroactivity, bridge/PoE/RF behavior, deletion/list/query,
broader RBAC, full CRUD, the 13-resource parent, every later tier, profile
publication, deployment, rewrite completion, and production readiness remain
open.

The first sandbox-only frontend aggregate failed solely because esbuild could
not spawn (`EPERM`); the approved exact command then passed. A direct
adversarial validator needed the same local subprocess permission. These were
environment restrictions, not product failures, and no command was weakened.
...
{
  "schema_version": 2,
  "digest": "source-v2:sha256:da2b93d51dbdc2dfbcb6e348e2f5b23f42439b5973169f683ddc39de285c5048",
  "files": 3064,
  "entries": [
    {
      "kind": "file",
    ...
    },
    {
      ...
      "path": "AGENTS.md",
      "size": 14225,
      "sha256": "sha256:b906932ba5c70193cbedac44fb446adbc3d424d03039a4f95bce32b89dc846f2"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 11896,
      "sha256": "sha256:900e0e190f9fb21fcce25dec0668511d8885325c9248ebd2f4465caa1cd43b96"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 311248,
      "sha256": "sha256:971493d46c75c1d2ea1f2914840cd7514b0f2c08436594dd5a8aa804e87868c8"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 91780,
      "sha256": "sha256:fcf3dd77e2aff59c09b7dfd5bac729b2ca42cbc4725d3c583a33ad3c35532e85"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "docs/STATUS.md",
      "size": 31794,
      "sha256": "sha256:f4d6bb1183555fa3858ff4a071860ca374d8ae134f97721f75656b6d66383e5b"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 22664,
      "sha256": "sha256:e059fd28df6fc3d856fc8b84f2fc37151b55544418a50ab7aa40f859cc5e986c"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 21793,
      "sha256": "sha256:458bbfda250b444941c2feed1efbf1522a31b1836dc17674bed918755afe9b5b"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 11017,
      "sha256": "sha256:a433921fdbcace55f4c9d877ad08c8c2e02415c5d57912714ed2dfd9a3672a39"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 141913,
      "sha256": "sha256:bc68059c60b68bf4e239ecc523d1387cad94d6a6429af257819091b8c46d3b09"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 32292,
      "sha256": "sha256:99a17f70b14302fb41bdccd9b0e3735c43253feaf59bc951715e7b2b26dc2011"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 27672,
      "sha256": "sha256:521391a56a728d13ee512e3b6c7833baa520d6be32ae6250596744cd72c4968b"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 19967,
      "sha256": "sha256:eff2273a4b8ef0711fc04ab4b88b5f831460b4af878f946e9e572d3d1e193f8a"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 29347,
      "sha256": "sha256:0c0ca2b9687751c272113fce8e29f5555711a201feb5c1537ffe73be3c1a47ec"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 16561,
      "sha256": "sha256:85b241af41eebbf44090e9150360dcead2a26fc5f35f4afd2ff1ddbb16beb91d"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 74701,
      "sha256": "sha256:9b1306fc64c6a4a0d5e50327b27296a6c5d3880d93d16745fb02251d18eef661"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 23013,
      "sha256": "sha256:bb2d9dbe56417dc0a69d54bbc517c7f46397ef330585c8e1568b3e9bda3b74ec"
    },
    {
      "kind": "file",
      "mode": "100644",
...
{
  "schema_version": 1,
  "tested_digest": "source-v2:sha256:da2b93d51dbdc2dfbcb6e348e2f5b23f42439b5973169f683ddc39de285c5048",
  "attestation_digest": "source-v2:sha256:da2b93d51dbdc2dfbcb6e348e2f5b23f42439b5973169f683ddc39de285c5048",
  "tested_files": 3064,
  "attestation_files": 3064,
