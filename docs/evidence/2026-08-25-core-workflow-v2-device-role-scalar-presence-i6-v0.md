# Core Workflow DeviceRole scalar write presence — 2026-08-25
...
- State: `evidence`; effective at exact claim revision
  `ad897478df134dcc71a08f068651de0b832ab913` after repository CI.
...
This artifact proves only DeviceRole `parent`, `name`, `slug`, `color`,
`vm_role`, `description`, and `comments` create/PUT/PATCH presence, defaults,
validation, numeric-ID parent input, generated operation-specific contracts,
shared typed REST/gRPC semantics, PostgreSQL durability, Vue handling, and the
eight packet tests specified by the
[`CW1-V2-02-I6` packet](../increments/CW1-V2-02-I6.md).

It does not complete DeviceRole CRUD, parent-cycle or uniqueness behavior,
delete protection, alternate parent input forms, list/get/delete/filter
behavior, `CW1-V2-02`, V2, any tier, profile state, traceability consumer,
deployment, publication, the rewrite, or production readiness.
...
- Entry revision:
  `5db615b90f933b187d9077523d2fa5c239e522cd`.
- Entry source digest:
  `source-v2:sha256:c1170741f0ceaae5171e5351c3b08f1258ac3e2e979009e3031d0dadf9846c61`
  with 3,043 entries.
- Entry source-manifest output SHA-256:
  `8629ddbe0ff1fe096ffa29b9ea73d70ce0c2e6a155b356ca760424ed5e919aea`.
- Reviewed packet revision:
  `96ead6bda301193e19dc7a492cacad3df3ee89aa`.
- Tested source candidate:
  `dddd7adbda72f5dd760202c4862ce23b17cdf180`.
- Tested source digest:
  `source-v2:sha256:be2168180bfbbb10406772d57e75210d32e5084051c4b765d4cf2954d958e621`.
- Tested owned entries: 3,050.
...
- Operation-specific DeviceRole metadata generates distinct
  `DeviceRoleCreate`, `DeviceRoleReplace`, and `DeviceRoleUpdate` request
  schemas. Create and replace require `name` and `slug`; update requires no
  field. Request parent is a nullable integer ID, response parent is a nullable
  `ObjectReference`, and only parent plus the two response timestamps are
  nullable in the response contract.
- POST omission creates a root role and defaults color to `9e9e9e`, VM role to
  `true`, and description/comments to `""`. PUT omission resets parent to root
  while preserving every other optional scalar. PATCH preserves every omitted
  scalar. Explicit null clears only parent and is rejected for the other six
  fields.
- Name and slug are required for POST/PUT, reject blank/null, trim surrounding
  whitespace, and enforce the pinned 100-code-point/ASCII-slug contracts.
  Color trims and accepts exactly six lowercase hexadecimal characters.
  Description trims and enforces 200 code points; comments trims without a new
  maximum claim. Concrete `false` and blank clears survive transport decoding.
...
- Every public mutation uses one application-owned transaction containing
  relationship resolution, candidate authorization, validation, persistence,
  hierarchy projection, and one DeviceRole object-change record. Validation,
  missing-parent, repository, and recorder failures preserve durable scalar
  state, timestamps, hierarchy state, and object-change counts.
- REST preserves omitted, null, blank, false, and concrete scalar intent.
  Supported gRPC FieldMask paths with absent optional values become explicit
  null intent; parent maps that intent to root and other fields reach the same
  validation. Unknown paths fail closed. The existing protobuf cannot
  independently encode omitted versus explicit-null parent on POST/PUT, and no
  protobuf was regenerated.
- Real PostgreSQL reloads every raw scalar after each successful operation and
  proves exact created/last-updated timestamps, role/global row counts,
  object-change counts, failed-validation immutability, and recorder rollback.
- Vue retains nullable response timestamps, numeric parent-ID/null mapping,
  required/default metadata, false/blank/concrete values, field-scoped errors,
  and a private normalized edit baseline that omits unchanged PATCH fields.
- Traceability adds only the unresolved DeviceRole scalar-presence assessment
  and remaps the resource-contract/create/replace/update rows. List/get/delete,
  hierarchy, uniqueness, deletion, verification, consumer, and tier rows stay
  open.

Parent cycles, uniqueness, alternate parent input grammar, delete protection,
list/get/delete/filter/search/order/pagination behavior, permissions beyond
the authorized fixtures, empty-PATCH semantics, full CRUD, and all other
resources remain outside this increment.

## Changed tested-source files

The tested candidate differs from the accepted I5 entry revision across
...
5. `docs/STATUS.md`
6. `docs/TESTING.md`
7. `docs/increments/CW1-V2-02-I5.md`
8. `docs/increments/CW1-V2-02-I6.md` — new
9. `docs/increments/README.md`
10. `netbox-backend/api/openapi/netbox-go-v1.yaml`
11. `netbox-backend/internal/adapters/grpc/workflow/device_role_typed_mapper.go`
12. `netbox-backend/internal/adapters/grpc/workflow/device_role_typed_mapper_test.go` — new
13. `netbox-backend/internal/adapters/grpc/workflow/device_role_typed_server_test.go`
14. `netbox-backend/internal/adapters/postgres/dcim/device_role_service_real_postgres_test.go` — new
15. `netbox-backend/internal/adapters/rest/netbox/workflow/device_role_scalar_presence_test.go` — new
16. `netbox-backend/internal/application/dcim/device_role_commands.go`
17. `netbox-backend/internal/application/dcim/device_role_commands_test.go` — new
18. `netbox-backend/internal/application/dcim/device_role_service.go`
19. `netbox-backend/internal/application/dcim/device_role_service_presence_test.go` — new
20. `netbox-backend/internal/domain/dcim/device_role.go`
21. `netbox-backend/internal/domain/dcim/device_role_test.go`
22. `netbox-backend/test/parity/device_role_scalar_presence_test.go` — new
...
The entry-to-candidate delta contains 3,107 insertions and 170 deletions,
including seven new regular files. No path was deleted, renamed, retargeted,
type-changed, mode-changed, or made executable. The I5/governance paths only
record the already-green I5 effective closeout from which I6 branched; they do
not change I5 behavior.
...
TestDeviceRoleScalarValidationLeavesStateUnchanged
TestDeviceRoleRESTScalarPresenceMatrix
TestDeviceRoleGRPCScalarPresenceMatrix
TestPostgresDeviceRoleScalarPresenceDurability
TestDeviceRoleScalarPresenceRESTGRPCParity
```

They span the domain, application, REST, gRPC, PostgreSQL, and parity packages.
Independent semantic, transaction/rollback, adapter/PostgreSQL/parity, and
generated-contract/Vue reviews found no remaining blocker or forbidden-scope
leakage. Review exposed missing positive-parent and repository-failure rollback
proof, incomplete PostgreSQL row/timestamp assertions, insufficient gRPC
create/replace/no-mask coverage, a contradictory mask diagnostic, and a
misleading REST spy outcome. All were corrected before the exact candidate
gates; gRPC PUT parity was added as well.

Red-first results were retained during execution:

- the contract validator initially passed 100/102 tests and failed only on
  missing DeviceRole metadata/mandatory enforcement;
- the four new domain/application fixed tests initially failed only on the
  absent `ValidatePatch` and replacement-patch behavior;
- the REST/gRPC/parity regressions exposed masked-absent non-parent handling
  and PUT optional-field resets;
- the Vue focused run initially failed two tests with 39 passing, and test
  typechecking emitted six expected nullable-timestamp diagnostics; and
- the final gRPC hardening test first failed only on the stale invalid-mask
  wording.

No test, comparator, normalizer, security control, lint rule, coverage floor,
generated check, or evidence requirement was weakened.
...
race-enabled replay. The parity package completed in 13.663 seconds without
race instrumentation and 178.592 seconds with it on the reviewed candidate.

The focused durable PostgreSQL test passed without a skip in 0.218 seconds on
the exact committed candidate. The final committed full L4 replay passed with
these package timings:

| Package                                | Result  |
| -------------------------------------- | ------: |
| `internal/database`                    |  2.330s |
| `internal/adapters/postgres/bootstrap` |  0.045s |
| `internal/adapters/postgres/dcim`      |  2.587s |
| `internal/adapters/postgres/dcim/row`  |  0.316s |
| `internal/adapters/postgres/ipam`      |  1.700s |
| `internal/adapters/postgres/ipam/row`  |  0.397s |
| `internal/adapters/postgres/changelog` |  0.004s |
| `internal/application/dcim`            |  0.005s |
| `internal/application/ipam`            |  0.070s |
| `internal/application/identity`        | 34.252s |
| `cmd/netbox_go_admin`                  |  6.521s |

The run used exact disposable database and role `netbox_i6_20260825` in the
existing test PostgreSQL container. No credential or complete DSN is retained.
Before deletion the database had zero connections. The database and role were
dropped; final database, role, and connection counts were `0|0|0`. The
disposable data is not recoverable.

The first sandbox-only backend gate failed solely because frozen cache/DAO
test helpers could not bind `127.0.0.1:0` (`EPERM`). Sandbox-only Node/Git,
esbuild, and PostgreSQL-socket attempts were likewise denied. The identical
approved isolated commands passed. These were environment-only failures, not
behavioral failures, and no gate was weakened.

## Generated contracts and frontend results

The final candidate passed:

- all 126 capability-profile and generated-OpenAPI adversarial tests;
...
- 41 focused Vue adapter/form tests and both production and test typechecks;
  and
- the complete local frontend gate: 29 files, 161 tests, 63.56% statement and
  80.29% branch coverage, formatting, lint, typechecking, and production build.
...
pinned toolchain path and task-local Go cache:
...
It exited 0 before the final `2026-08-25T06:34:00Z` digest confirmation.
Results included:

- backend lint: zero issues;
- backend coverage: 12.8495% (37,438/291,358), above the retained 12.4001%
...
- every contract, traceability, frontend, and generated-output result above;
  and
- all local links valid across 169 Markdown files.
...
- Run: [32817616606](https://github.com/jihadismail8/netbox-go/actions/runs/32817616606).
- Job `check`: [97708978672](https://github.com/jihadismail8/netbox-go/actions/runs/32817616606/job/97708978672).
- Branch: `work/cw1-v2-02-i6-device-role-presence`.
- Head SHA: `dddd7adbda72f5dd760202c4862ce23b17cdf180`.
- Run start/completion: `2026-08-25T06:35:10Z`–`2026-08-25T06:55:25Z`.
- Job start/completion: `2026-08-25T06:35:13Z`–`2026-08-25T06:55:24Z`.
...
- The independent frontend replay also passed 29 files and 161 tests; its
  environment reported 63.02% statement and 81.79% branch coverage, distinct
  from the local candidate result retained above.

This independent result exercised exact tested source candidate
`dddd7adbda72f5dd760202c4862ce23b17cdf180`, not a different merge revision.

## Digest-excluded claim local gate

The evidence-only worktree changes only the two source-v2-excluded paths
listed below. Its source digest, 3,050-entry manifest, and canonical manifest
...
env \
  ...
  GOCACHE=/tmp/go-cache \
  GOFLAGS=-buildvcs=false \
  GOLANGCI_LINT_CACHE=/tmp/netbox-go-i6-evidence-golangci-cache \
  npm_config_cache=/tmp/netbox-go-i6-npm-cache \
  make check
```

It exited 0 and retained backend coverage at 12.8495% (37,438/291,358), 54
measured packages and one reviewed exclusion, all 29 frontend files and 161
tests at 63.56% statement coverage, all 96 traceability-validator and 126
capability/OpenAPI adversarial tests, the 13-resource/three-interface/
17-scenario/293-row profile, 33 OpenAPI paths and 86 operations, generated
outputs, inventory, and all local links across 170 Markdown files.

## Claim exact-SHA CI and receipt boundary

- Workflow: `repository-gate`.
- Run: [32820735173](https://github.com/jihadismail8/netbox-go/actions/runs/32820735173).
- Job `check`: [97718056433](https://github.com/jihadismail8/netbox-go/actions/runs/32820735173/job/97718056433).
- Branch: `work/cw1-v2-02-i6-device-role-presence`.
- Head SHA: `ad897478df134dcc71a08f068651de0b832ab913`.
- Run start/completion: `2026-08-25T07:15:45Z`–`2026-08-25T07:35:48Z`.
- Job start/completion: `2026-08-25T07:15:47Z`–`2026-08-25T07:35:47Z`.
- Conclusion: **success**; every setup, repository, post, and completion step
  succeeded, with no cancellation or non-success conclusion.

That exact-SHA result made only bounded I6 `evidence`. The claim commit
retains the exact two-path old/new mapping whose canonical JSON SHA-256 is
`7f3ad11a1e512b3ba4212d945dec0e2a08873315c582c5064435fbe8684eb626`.
...
increment's complete seven-field POST/PUT/PATCH omitted/null/blank/zero/false/
concrete matrix, numeric-ID-only parent input, or rejected-DeviceRole durable
side-effect checks. No local adapter/parity/PostgreSQL test substitutes for
that boundary, so strict REST differential proof, REST T2, and corresponding
gRPC T3 remain pending. The Vue unit/type boundary earns no browser T4.

Generic framework coercion, malformed UTF-8 behavior, byte-exact generic
diagnostics, empty PATCH, alternate parent input forms, self/descendant cycles,
uniqueness, duplicate races, delete protection, list/get/delete/filter/search/
order/pagination, permissions beyond the authorized fixtures, and the
13-resource parent remain open. The locked frontend dependency findings remain
outside I6.

## Gate disposition

- L0–L3: passed for the bounded DeviceRole domain, application, REST,
...
1. `docs/evidence/2026-08-25-core-workflow-v2-device-role-scalar-presence-i6-v0.md`
   — new
...
are byte-identical at 3,050 entries and that the complete derived source diff
is empty. No owned source entry is added, removed, changed, renamed,
retargeted, type-changed, or made executable.

Independent reviews confirmed that the exact two-path claim mapping changes no
...
evidence-only local gate and exact-SHA claim CI passed at their separate
boundaries. The receipt and project-owner evidence review must confirm the
...
`dddd7adbda72f5dd760202c4862ce23b17cdf180`. The evidence-only worktree
reconstructs the same bytes, so this is also its complete current manifest.

```json
{
  "schema_version": 2,
  "digest": "source-v2:sha256:be2168180bfbbb10406772d57e75210d32e5084051c4b765d4cf2954d958e621",
  "files": 3050,
  "entries": [
    {
      "kind": "file",
    ...
    },
    {
      ...
      "path": "AGENTS.md",
      "size": 11908,
      "sha256": "sha256:b014d83779d0c1f92531e90bf5d1db4961c7f905cccfd1ab5b0593994d00914c"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 10511,
      "sha256": "sha256:79b75b26bebb617b633400ce4eb104235691801325059d58035665ebb83b8d0b"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 309465,
      "sha256": "sha256:adced3d39d4f3b29d960c925b5eb41b10688671c7adedccc383d944308d920f2"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 87229,
      "sha256": "sha256:a2b47b7a018fc36758f94a6530905c4011e097d3d032e9f38adc2492923d9703"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "docs/STATUS.md",
      "size": 28917,
      "sha256": "sha256:3b1729eea581a31d609958ccc641c88ce99d99e37195ed760f8b2a029a30f912"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 19798,
      "sha256": "sha256:b658b9bf395ecdafe43d3348ff5d4bcb9cedddc5a57ac7d8e5735af07cac08b8"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 20250,
      "sha256": "sha256:b20d95bf0cf9cc2e757e4431c109a8c045c8a816bb73b834b3b0b71f53a5914b"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 8666,
      "sha256": "sha256:d493644dfb737cfbd986784d8e0d375ca6048ab96dcd123d3a5a9a226fbef085"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 139219,
      "sha256": "sha256:03cd15a6e1c3791fef22bcb8c247453406e2d3a77e33a85426a371068152bc70"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 12673,
      "sha256": "sha256:84cf8668c8f1e18cc1160b956c28dd695304fc3a087e2503660067c0453876bd"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 9811,
      "sha256": "sha256:319e89063eb2bcbedba8cfaba50665a17fb7441cdcd81d10a1648a246bc45720"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 6292,
      "sha256": "sha256:c7426118995e9bfcca6cf9e36887b9d134b6728d29c6d6505a01d8a56519677e"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 15419,
      "sha256": "sha256:00baed0d1628c920454502349f569b7d0bf4f52c3fff5c0a6b5a411034123b5f"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 16304,
      "sha256": "sha256:619674c20d37f8ae1e43c08d229d0ffea7ff50ceb970a3e687e8c71b2ca92447"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 3413,
      "sha256": "sha256:1b769cff4d000b1a473a696c675e9cca520638a8d86ee0c0b10a02b5d17d21d1"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 23746,
      "sha256": "sha256:45b729bcb8cdbf05492bb4291b0ac362bd3c50b1ccb057432f069e93d67f8799"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 23981,
      "sha256": "sha256:b7d3bd3e7467b2d5915c061fc8123bb5c905e91dc0e690ac457b14d1a8e6cde4"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 19789,
      "sha256": "sha256:aee61e4c997dca3e80d69b5bef76849dc4b9c3b3b94887a912d45dc2cd8b5c15"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 20650,
      "sha256": "sha256:6376f0bf05e2907e579c740fa6bc70263772501b9a9267a15834b8cd3a4d3dcf"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 16175,
      "sha256": "sha256:cf9bdf49a0f210f9c0657a9ebdb6ca7dbe37137f2d3d697b2fa148ebfdd2b960"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 50073,
      "sha256": "sha256:49ed702fc20d8f71f572edf8c660c7ccbc05c24b3119e54159ab976ee0179b86"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 20942,
      "sha256": "sha256:06df8f4c98cb6bdf53296c3da8c115c0e6902560935b25e6c8a8d7114b848da6"
    },
    {
      "kind": "file",
      "mode": "100644",
...
{
  "schema_version": 1,
  "tested_digest": "source-v2:sha256:be2168180bfbbb10406772d57e75210d32e5084051c4b765d4cf2954d958e621",
  "attestation_digest": "source-v2:sha256:be2168180bfbbb10406772d57e75210d32e5084051c4b765d4cf2954d958e621",
  "tested_files": 3050,
  "attestation_files": 3050,
