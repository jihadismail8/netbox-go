# Core Workflow DeviceType scalar write presence — 2026-08-25
...
- State: `evidence`; effective at exact claim revision
  `c6ffdec22b5f47b529feba7fc4bb864b95a7ac13` after repository CI.
...
This artifact proves only DeviceType `manufacturer`, `model`, `slug`,
`part_number`, `u_height`, `exclude_from_utilization`, `is_full_depth`,
`airflow`, `description`, and `comments` create/PUT/PATCH presence, defaults,
validation, numeric-ID Manufacturer input, generated operation-specific
contracts, shared typed REST/gRPC semantics, PostgreSQL durability, Vue
handling, and the eight packet tests specified by the
[`CW1-V2-02-I7` packet](../increments/CW1-V2-02-I7.md).

It does not complete DeviceType CRUD, uniqueness, positioned-Device height
transitions, template or Device propagation, deletion behavior, alternate
Manufacturer input forms, list/get/delete/filter behavior, `CW1-V2-02`, V2,
any tier, profile state, traceability consumer, deployment, publication, the
rewrite, or production readiness.
...
bounded `evidence` state became effective when exact-SHA CI passed for the
digest-excluded claim revision. Its source-excluded receipt exact-SHA CI and
project-owner evidence review remain separate later boundaries.

## Entry and tested source

- Entry revision:
  `fca71d28876503db6af45fe9311527e260ac3910`.
- Entry source digest:
  `source-v2:sha256:306fbf5a08c7078d2c02e893e2be1b9a8ce27d66eabd5176c93f0cbf67ea55ef`
  with 3,050 entries.
- Entry source-manifest output SHA-256:
  `01d46ad9f9c8cac99223016f18e8c8f70b3fdc1528e8607a5b26d1b2d2ca0a40`.
- Reviewed packet revision:
  `f1053daa96498fc2fc592213c15af9f85466aecd`.
- Tested source candidate:
  `e2ad1acc33b84f20f24418d89b3b881b897b7ed3`.
- Tested source digest:
  `source-v2:sha256:8930fa5fbe487df4c225a301c674db096664cccaf3f0c53df93c51e59edaeba7`.
- Tested owned entries: 3,057.
- Canonical source-manifest output SHA-256:
  `7399809eb7aac3ecd782fa95902efc38a7e7d16a4740e74b009bd4f1993c48e2`.
- Evidence-claim source digest: unchanged from the tested source digest, with
  the same 3,057 owned entries.
- Evidence-claim source-manifest output SHA-256: unchanged at
  `7399809eb7aac3ecd782fa95902efc38a7e7d16a4740e74b009bd4f1993c48e2`.
- Complete derived source-manifest diff SHA-256:
  `b1a323d008375c97896e77b9acfab1223c047cac76c533479162bce2cd26d99e`.
- Pinned NetBox oracle revision:
  `fbb948d30e79ce657fac62994a22aca72c1770a9` (`v4.4.6-7-gfbb948d30`).
- Go: `go1.26.0 linux/amd64`.
- Node.js: `v24.18.0`.
- npm: `11.16.0`.

The packet was authored and independently reviewed before behavior editing.
Execution used the standing project-owner authorization recorded in that
packet; no separate packet-acceptance revision exists and none is invented
here. The preserved pre-main-rebase I1 stash was not applied, modified, or
dropped. The exact feature branch was pushed normally; `main` was not changed.

## Implemented boundary

- Operation-specific DeviceType metadata generates distinct
  `DeviceTypeCreate`, `DeviceTypeReplace`, and `DeviceTypeUpdate` request
  schemas. Create and replace require Manufacturer, model, and slug; update
  requires no field. Request Manufacturer is an integer ID, response
  Manufacturer is a non-null `ObjectReference`, request height is
  `number`/`double`, and request airflow is a nullable scalar while response
  airflow is a nullable choice envelope.
- POST defaults part number, description, and comments to `""`, height to
  `1.0`, exclusion to `false`, full depth to `true`, and airflow to SQL
  `NULL`. PUT omission resets only height to `1.0` while preserving every
  other optional scalar. PATCH preserves every omission. Explicit null clears
  only airflow and is rejected for every other owned field.
- Manufacturer input stays inside the positive numeric-ID envelope. Model and
  slug are required for POST/PUT, reject blank/null, trim whitespace, and
  enforce the pinned length and ASCII-slug contracts. Part number and
  description trim with their pinned limits; comments trim without a new
  maximum claim. False, zero, blank, concrete, and null intent survive typed
  transport decoding where representable.
- Height uses exact half-unit storage. The shared parser mirrors pinned DRF
  DecimalField conversion and lexical precision for fixed, leading/trailing
  decimal-point, exponent, underscore, signed-zero, and Unicode decimal-digit
  spellings before enforcing max digits, one decimal place, three whole
  digits, non-negativity, and the discrete `0..999.5` half-unit set.
- Airflow accepts only the ten pinned values plus stored blank. SQL `NULL` and
  stored blank remain distinct in PostgreSQL even though pinned REST renders
  both as null; concrete responses retain their choice envelope.
- The typed command/domain boundary preserves operation-specific presence,
  returns combined violations in deterministic field order without discarding
  valid sibling intent, and previews rejected replacements/patches without
  mutating loaded state.
- Every public mutation uses one application-owned transaction containing
  relationship resolution, authorization, normalization, validation,
  persistence, transition checks already owned by the service, and exactly
  one DeviceType object-change record. Validation, missing-Manufacturer,
  repository, and recorder failures preserve durable state, timestamps, and
  object-change counts.
- REST preserves omitted, null, blank, zero, false, and concrete intent.
  Supported gRPC FieldMask paths with absent optional values become explicit
  null intent; only airflow clears and every non-null scalar reaches the same
  validation. Unknown paths fail closed. Frozen protobuf limitations remain
  explicit and no protobuf was regenerated.
- Real PostgreSQL reloads raw scalar and relationship state after successful
  operations and proves timestamps, exactly one object change, absent
  Device/template dependents, failed-validation immutability, and recorder
  rollback.
- Vue retains nullable response timestamps, numeric Manufacturer-ID mapping,
  required/default metadata, exact airflow choices, false/zero/blank/null
  values, field-scoped errors, and a private normalized edit baseline that
  emits `{}` for unchanged edits and one scalar for one dirty field.
- Traceability adds only the unresolved DeviceType scalar-presence assessment
  and remaps create/replace/update. Resource/list, get/delete, uniqueness,
  transition, deletion, verification, consumer, and tier rows stay open.

Positioned-Device transitions, uniqueness, alternate Manufacturer grammar,
delete protection/cascade, dependent templates/Devices, list/get/delete/
filter/search/order/pagination behavior, permissions beyond authorized
fixtures, empty-PATCH semantics, full CRUD, and all other resources remain
outside this increment.

## Changed tested-source files

The tested candidate differs from the accepted I6 entry revision across
exactly 29 regular mode-`100644` paths:
...
5. `docs/STATUS.md`
6. `docs/TESTING.md`
7. `docs/increments/CW1-V2-02-I6.md`
8. `docs/increments/CW1-V2-02-I7.md` — new
9. `docs/increments/README.md`
10. `netbox-backend/api/openapi/netbox-go-v1.yaml`
11. `netbox-backend/internal/adapters/grpc/workflow/device_type_typed_handler.go`
12. `netbox-backend/internal/adapters/grpc/workflow/device_type_typed_handler_test.go`
13. `netbox-backend/internal/adapters/grpc/workflow/device_type_typed_mapper_test.go` — new
14. `netbox-backend/internal/adapters/postgres/dcim/device_type_service_real_postgres_test.go` — new
15. `netbox-backend/internal/adapters/rest/netbox/workflow/device_type_scalar_presence_test.go` — new
16. `netbox-backend/internal/application/dcim/device_type_commands.go`
17. `netbox-backend/internal/application/dcim/device_type_commands_test.go` — new
18. `netbox-backend/internal/application/dcim/device_type_service.go`
19. `netbox-backend/internal/application/dcim/device_type_service_presence_test.go` — new
20. `netbox-backend/internal/domain/dcim/device_type.go`
21. `netbox-backend/internal/domain/dcim/device_type_test.go`
22. `netbox-backend/test/parity/device_type_scalar_presence_test.go` — new
...
27. `scripts/validate_capability_profile.mjs`
28. `scripts/validate_capability_profile.test.mjs`
29. `scripts/validate_openapi.mjs`

The entry-to-candidate delta contains 3,719 insertions and 237 deletions,
including seven new regular files. No path was deleted, renamed, retargeted,
type-changed, mode-changed, or made executable. The I6/governance paths only
record the already-green I6 effective closeout from which I7 branched; they do
not change I6 behavior.

## Fixed regression and review boundary

The exact eight packet-named Go tests were discovered once each and passed:

```text
TestDeviceTypeScalarNormalizationContract
TestDeviceTypeScalarCommandPresenceMatrix
TestReplaceDeviceTypePreservesOmittedState
TestDeviceTypeScalarValidationLeavesStateUnchanged
TestDeviceTypeRESTScalarPresenceMatrix
TestDeviceTypeGRPCScalarPresenceMatrix
TestPostgresDeviceTypeScalarPresenceDurability
TestDeviceTypeScalarPresenceRESTGRPCParity
```

They span the domain, application, REST, gRPC, PostgreSQL, and parity packages.
Independent backend and generated-contract/Vue reviews found no forbidden
scope leakage. Backend review found one pre-commit DecimalField normalization
gap: the first height parser rejected pinned-valid alternate and Unicode
decimal spellings. A lowest-layer regression reproduced that divergence; the
shared exact parser was corrected, linted, race-tested, and independently
re-reviewed with no remaining finding before the candidate commit.

Red-first results were retained during execution: the new operation metadata,
application presence/default behavior, REST/gRPC/parity mapping, PostgreSQL
durability, and Vue serialization tests initially failed only on their absent
I7 behavior. No test, comparator, normalizer, security control, lint rule,
coverage floor, generated check, or evidence requirement was weakened.

## Focused, race, PostgreSQL, and full-L4 results

The final unchanged source digest passed exact-name discovery, the exact eight
fixed tests, the complete affected non-PostgreSQL package set, and its combined
race-enabled replay. The parity package completed in 13.731 seconds without
race instrumentation and 174.527 seconds within the exact committed full race
gate.

The focused durable PostgreSQL test passed without a skip in 0.229 seconds on
the exact committed candidate. The final committed full L4 replay passed with
these package timings:

| Package                                | Result  |
| -------------------------------------- | ------: |
| `internal/database`                    |  2.206s |
| `internal/adapters/postgres/bootstrap` |  0.031s |
| `internal/adapters/postgres/dcim`      |  2.707s |
| `internal/adapters/postgres/dcim/row`  |  0.299s |
| `internal/adapters/postgres/ipam`      |  1.510s |
| `internal/adapters/postgres/ipam/row`  |  0.357s |
| `internal/adapters/postgres/changelog` |  0.003s |
| `internal/application/dcim`            |  0.005s |
| `internal/application/ipam`            |  0.061s |
| `internal/application/identity`        | 34.334s |
| `cmd/netbox_go_admin`                  |  6.320s |

The run used exact disposable database and role `netbox_i7_20260825` in the
existing test PostgreSQL container. No credential or complete DSN is retained.
After all exact committed replays, the database and role were dropped and
their final existence counts were `0|0`. The disposable data is not
recoverable.

The first sandbox-only frontend gate failed solely because esbuild could not
spawn (`EPERM`), and a repository-gate invocation with a Node-only path failed
before testing because it hid `go` and `gofmt`. A sandbox-only backend replay
also reached frozen cache/DAO helpers that could not bind their loopback test
sockets (`EPERM`). The corrected pinned-path and approved isolated commands
passed. These were environment/invocation failures, not behavioral failures,
...
- all 157 capability-profile and generated-OpenAPI adversarial tests;
- all 96 traceability-validator tests;
- profile validation at 13 resources, three interfaces, 17 scenarios, and 293
  traceability rows;
- generated-document consistency and OpenAPI validation at 33 paths and 86
  operations;
- generated inventory and compatibility-driver syntax checks;
- 47 focused Vue adapter/form tests and both production and test typechecks;
  and
- the complete local frontend gate: 29 files, 167 tests, 64% statement and
  80.78% branch coverage, formatting, lint, typechecking, and production build.

The generated OpenAPI file was produced by the repository generator and was
not hand edited. The locked frontend dependency tree reports three
high-severity audit findings; dependency changes are outside this packet, and
no finding is represented as resolved.

## Whole-repository result

The exact committed candidate passed this `make check` invocation with the
pinned toolchain path:

```bash
env \
  PATH=/home/jihad/.local/go/bin:/home/jihad/.nvm/versions/node/v24.18.0/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin \
  make check
```

It exited 0 before the final digest confirmation. Results included:

- backend lint: zero issues;
- backend coverage: 12.9064% (37,621/291,492), above the retained 12.4001%
  (36,013/290,425) floor, with 54 measured packages and one reviewed
  exclusion;
- every contract, traceability, frontend, and generated-output result above;
  and
- all local links valid across 171 Markdown files.

`git diff --check`, source-digest, complete source-manifest, generated-output,
inventory, and documentation checks also passed. The tested source digest and
manifest were unchanged across focused, affected, race, PostgreSQL, L4,
contract, frontend, backend, whole-repository, commit, push, and independent
candidate-CI boundaries.

## Independent candidate CI

- Workflow: `repository-gate`.
- Run: [32843553110](https://github.com/jihadismail8/netbox-go/actions/runs/32843553110).
- Job `check`: [97788121195](https://github.com/jihadismail8/netbox-go/actions/runs/32843553110/job/97788121195).
- Branch: `work/cw1-v2-02-i7-device-type-presence`.
- Head SHA: `e2ad1acc33b84f20f24418d89b3b881b897b7ed3`.
- Run start/completion: `2026-08-25T11:40:45Z`–`2026-08-25T12:00:57Z`.
- Job start/completion: `2026-08-25T11:40:49Z`–`2026-08-25T12:00:57Z`.
...
- CI retained zero lint findings, backend coverage at 12.9064%
  (37,621/291,492), 29 passing frontend files, all 96 traceability tests, all
  157 capability/OpenAPI adversarial tests, the 13-resource/17-scenario/
  293-row profile, 33 OpenAPI paths, 86 operations, and 171 valid Markdown
  files.

This independent result exercised exact tested source candidate
`e2ad1acc33b84f20f24418d89b3b881b897b7ed3`, not a different merge revision.

## Digest-excluded claim local gate

The evidence-only worktree changes only the two source-v2-excluded paths
listed below. Its source digest, 3,057-entry manifest, and canonical manifest
SHA-256 therefore remain byte-identical to the tested candidate. The complete
derived source-manifest diff is empty.

Immediately before the claim commit, the exact evidence-only worktree passed
this pinned command without any later file edit:
...
It exited 0 and retained backend coverage at 12.9064% (37,621/291,492), 54
measured packages and one reviewed exclusion, all 29 frontend files and 167
tests, all 96 traceability-validator and 157 capability/OpenAPI adversarial
tests, the 13-resource/three-interface/17-scenario/293-row profile, 33 OpenAPI
paths and 86 operations, generated outputs, inventory, and all local links.

## Claim exact-SHA CI and receipt boundary

- Workflow: `repository-gate`.
- Run: [32846837001](https://github.com/jihadismail8/netbox-go/actions/runs/32846837001).
- Job `check`: [97798381347](https://github.com/jihadismail8/netbox-go/actions/runs/32846837001/job/97798381347).
- Branch: `work/cw1-v2-02-i7-device-type-presence`.
- Head SHA: `c6ffdec22b5f47b529feba7fc4bb864b95a7ac13`.
- Run start/completion: `2026-08-25T12:18:00Z`–`2026-08-25T12:38:06Z`.
- Job start/completion: `2026-08-25T12:18:02Z`–`2026-08-25T12:38:05Z`.
- Conclusion: **success**; every setup, repository, post, and completion step
  succeeded, with no cancellation or non-success conclusion.

This exact-SHA result made only the bounded I7 DeviceType result `evidence`.
The canonical claim mapping was reconstructed from the tested candidate and
claim revisions at SHA-256
`2207b396ae9c154b6a1bcb699a8a24a352bf63929cbdecba7d111702e4e33fc6`;
the claim commit itself did not embed that mapping. This receipt commit retains
the full reconstructed claim mapping together with its own two-path mapping.
Both revisions change only the source-v2-excluded evidence paths listed below,
so the source digest, complete manifest, and empty derived diff remain
unchanged. Receipt exact-SHA CI and project-owner evidence review remain.

## External differential and residual limits

The focused external differential was not run. The compatibility driver
passed syntax validation, but its current broad matrix does not prove this
increment's complete ten-field POST/PUT/PATCH omitted/null/blank/zero/false/
concrete matrix, DecimalField lexical normalization, SQL-null/stored-blank
airflow distinction, or rejected-DeviceType durable side effects. No local
adapter/parity/PostgreSQL test substitutes for that boundary, so strict REST
differential proof, REST T2, and corresponding gRPC T3 remain pending. The Vue
unit/type boundary earns no browser T4.

Generic coercion, malformed UTF-8 behavior, byte-exact generic diagnostics,
empty PATCH, alternate Manufacturer forms, uniqueness/races, positioned-
Device height transitions, deletion/cascade, dependent templates/Devices,
list/get/delete/filter/search/order/pagination, broader RBAC, and the
13-resource parent remain open. The locked frontend dependency findings remain
outside I7.

## Gate disposition

- L0–L3: passed for the bounded DeviceType domain, application, REST,
  generated contract, gRPC parity regression, and Vue boundary on one
  unchanged tested source digest.
- L4 real PostgreSQL: passed without skips, and the exact disposable database
  and role were removed afterward.
- L5 differential REST: not run; no T2 claim is made.
- L6 gRPC T3: not earned because corresponding REST T2 is absent. Shared-core
  REST/gRPC parity passed only as a focused pre-T2 regression.
...
- L9: tested-digest confirmation, pinned repository gates, independent
  candidate exact-SHA CI, the digest-excluded claim local replay, and exact-SHA
  claim CI passed. Bounded I7 `evidence` is effective. Its source-excluded
  receipt exact-SHA CI and project-owner evidence review remain.
...
The claim changed exactly these two source-v2-excluded evidence paths, and this
receipt changes exactly the same two paths:

1. `docs/evidence/2026-08-25-core-workflow-v2-device-type-scalar-presence-i7-v0.md`
   — new
2. `docs/evidence/README.md`

The complete manifest retained below represents the tested candidate, claim,
and receipt worktrees. Independent reconstruction confirmed that they are
byte-identical at 3,057 entries and that the complete derived source diff is
empty. Independent review also confirmed the reconstructed canonical claim
mapping recorded above. No owned source entry is added, removed, changed,
renamed, retargeted, type-changed, or made executable.
...
GitHub credential, or complete configuration object is retained here. The
evidence-only local gate and exact-SHA claim CI both passed at their separate
boundaries. The receipt requires exact-SHA repository CI; later project-owner
evidence review must confirm the bounded proof, the unexecuted differential
boundary, and the absence of parent/tier/profile/consumer promotion before any
later state transition.

## Complete tested source manifest

The block below is the exact canonical output for tested revision
`e2ad1acc33b84f20f24418d89b3b881b897b7ed3`. The evidence-only worktree
reconstructs the same bytes, so this is also its complete current manifest.

```json
{
  "schema_version": 2,
  "digest": "source-v2:sha256:8930fa5fbe487df4c225a301c674db096664cccaf3f0c53df93c51e59edaeba7",
  "files": 3057,
  "entries": [
    {
      "kind": "file",
    ...
    },
    {
      ...
      "path": "AGENTS.md",
      "size": 13033,
      "sha256": "sha256:b983f075e055ebc24bc66eae5d50457314bf7899b87fcbac26d86eacf9f7ee77"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 11268,
      "sha256": "sha256:3b3629972c3f7ab015d0c9024267f88cd6368fbd4d12860d13a5cf5442a68c01"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 310418,
      "sha256": "sha256:22858bea178406ee34808f07f406188d21ddf32b0a3eda92f9272d7093204589"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 89456,
      "sha256": "sha256:77235a8d41c3cd31a69b27cee96edc914e90d11b248ae7659336ed410a0de446"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "docs/STATUS.md",
      "size": 30412,
      "sha256": "sha256:574b043f39b97df51c055c8c64affb7d77d5fb59f6b54c3178d8c9546e39f86c"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 21316,
      "sha256": "sha256:8f3d76258d63fe672ccdaeeddd39614feb9a645f16c07e961c0762438b964b5c"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 22066,
      "sha256": "sha256:6529cb8fb9ab14fb474e98748ace9a68eabc1fe51294b225f75574c1ba014b61"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 9844,
      "sha256": "sha256:2ca4dde2619c31d33d7ce9ff10b14c9743fc80b81b65d2d6328c55a35d2f3173"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 140767,
      "sha256": "sha256:5a53818ec103737d8f522db4d554616c840ed76c4339f6ade73d19539fee4318"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 11804,
      "sha256": "sha256:6748638c26b272fa859fa44806578e556bfd5ef97f13b1eb63821bc5d7f816c8"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 4760,
      "sha256": "sha256:50d8395a8b7bef7c23a9001b44bbf3831f2f17650e5420bfb702527b2ef82a4e"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 13474,
      "sha256": "sha256:3714d701ccedb3368d53d4980e158d5569161e0cc0b8be44b606f1bbb2931ed0"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 9585,
      "sha256": "sha256:902ff8d8a8e1903f52a60387c3a8c437c1f6c9029d6a896589b6ca89aacda2f9"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 3991,
      "sha256": "sha256:06ab10daccbfa7586dca452721c2c20ffe8e882873349dd4dd6b43682ead6369"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 13554,
      "sha256": "sha256:e6b31ba2b897965b245a51829c3c31b1ab4eaf49f848f100bbe029b9c806c8dd"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 10538,
      "sha256": "sha256:892a7a175c8458ee99a0df22683131c5ea372c73e13e132c0de0dad2b0f0537c"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 7558,
      "sha256": "sha256:b9e1c3efffbcc9a4bbcab8530375d05f5371e1fef89fe526b0cc0e481851ba3f"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 18126,
      "sha256": "sha256:c79e8df80a36a0b2a9bcd6ed15dc7e56df1ecdf2ea991602f9cad0fe8bee8efc"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 14407,
      "sha256": "sha256:a776d0430c983eecf86db7cf0e46e9f1bb8fc5fbb133e7913e84bd3fd58747e2"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 2585,
      "sha256": "sha256:8aabec637851329a3fe5e4a9e0d22d91633fd53719da9861bdf24f6023ad9ca5"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 21999,
      "sha256": "sha256:9cfb0a2a877144cf3610849ada88dd0573de9f1215eccc5bd54431f44d98e6ac"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 4849,
      "sha256": "sha256:863450453e2d2581ad62520f43999e4703e06e9c0fc92bb06ca0507e206e4649"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 28115,
      "sha256": "sha256:ee51e942153be3beed90db863f76ee022ffa0a3f169270fec32ac05d1c2a366b"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 26021,
      "sha256": "sha256:afdc1860bdfa76b7ab9c02fdfeb715f97bf51eab6efcc3e620a699759f375f4e"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 19878,
      "sha256": "sha256:f522ca1cdac97670d2820e6453e88a73dcffb45ee83510f5c07d85f1a713ed77"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 25291,
      "sha256": "sha256:017c898816c141baed2655b0ac3cd49befb1b22e20871e1c78bdae5e9d3ee8eb"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 31961,
      "sha256": "sha256:d18beb7bc7545ea5300e0aaa67e7fbbe3233401d2a03795628462a8f73face45"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 16358,
      "sha256": "sha256:07f604a57d85eb133392b273478d199d060de179d983461d1dada19bf165fb73"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 63443,
      "sha256": "sha256:6c426b174237d3b177b7b694a266c43650ca2446d292ffac82f358716e1cccee"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 22189,
      "sha256": "sha256:1466e1f2c5ab518bfd8cbb097bb4ae1f03c99d4c89de80475987b22f68cf1866"
    },
    {
      "kind": "file",
      "mode": "100644",
...
manifest and the byte-identical evidence-only worktree manifest.

```json
{
  "schema_version": 1,
  "tested_digest": "source-v2:sha256:8930fa5fbe487df4c225a301c674db096664cccaf3f0c53df93c51e59edaeba7",
  "attestation_digest": "source-v2:sha256:8930fa5fbe487df4c225a301c674db096664cccaf3f0c53df93c51e59edaeba7",
  "tested_files": 3057,
  "attestation_files": 3057,
