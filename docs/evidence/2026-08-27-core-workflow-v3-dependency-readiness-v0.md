# Core Workflow dependency-aware readiness — 2026-08-27
...
reviewed [`CW1-V3-01` packet](../increments/CW1-V3-01.md): process-only HTTP
liveness, request-time PostgreSQL-aware HTTP readiness, empty-service standard
gRPC Health Check state, fail-closed named-service and Watch behavior, one
shared startup-composed readiness checker, seven fixed named tests, and
auxiliary constructor coverage.

It does not prove real deployment dependency loss/recovery, streaming health
monitoring, a startup probe, schema/bootstrap policy, reconnect/restart
behavior, locking, rollback, Compose operation, TLS, production observability,
or production readiness. It changes no Managed Object behavior, REST or gRPC
compatibility tier, browser workflow, Capability Profile metadata,
resource/scenario/traceability consumer, V3 parent, publication, rewrite, or
production state. `CW1-V3-02` through `CW1-V3-05` remain open.
...
- Entry source digest:
  `source-v2:sha256:8425dc7af3f91293fd7d1d36fa8b0101f2a4ec962082a1598e8b88471577fdfe`
  with 3,071 entries.
- Entry source-manifest output SHA-256:
  `9c370809f9eaa5b52b61158879f38f17870339df30e5dfff8598459575bc8b8a`.
- Reviewed packet revision:
  `7905c579d7265e6507f72c36f07a2eca9de8a15a`.
...
- Exact packet seven-path mapping SHA-256:
  `48c7659c038848a9e633ee076ddda7c4f60a169d231f9c5d7763e57a377dd3ea`.
- Tested source candidate:
  `58241d7f87b642e6b7eca279592ad3759a0f5a06`.
- Tested source digest:
  `source-v2:sha256:5cb32b753a4ac62544b2db24720b70c89904b0ae24731627e236dcd6c68564e9`.
- Tested owned entries: 3,075.
- Canonical tested source-manifest output SHA-256:
  `4b5cc4305dcae060144aea1cc72746e367cfabbc699142423ffac1b06c23f8b7`.
- Exact 17-path candidate mapping SHA-256:
  `1670586bb66e5caa1fb5117ecb4ccc342e2ad90d4782a6bd869196f7dd945dea`.
- Complete evidence-claim source-manifest diff SHA-256:
  `1313bb17b7dd1478ae0016e45c5c4b22009efb898023c398f2ec760d50dfa9fa`.
- Go: `go1.26.0 linux/amd64`.
- Node.js: `v24.18.0`.
- npm: `11.16.0`.

The packet was authored at `2026-08-27T09:47:02Z`, independently reviewed at
`2026-08-27T09:56:08Z`, and passed its clean local repository gate from
`2026-08-27T09:58:15Z` through `2026-08-27T10:03:19Z`. That gate exited 0 and
its credential-free log has SHA-256
...
passed from `2026-08-27T12:50:34Z` through `2026-08-27T13:11:07Z` for the run
and `2026-08-27T12:50:36Z` through `2026-08-27T13:11:06Z` for the job.
...
one-file coverage-ownership amendment at
`645adaa3ba3024ae655f6880aa7c576c33bd99fc` authorized only the additive
measured-package row and exact non-regressing aggregate refresh. Its clean
detached-worktree repository gate ran from `2026-08-27T13:51:12Z` through
`2026-08-27T13:56:14Z`, exited 0, and has credential-free log SHA-256
`17d78dbd8ffab841057e80d86c238f4ad8a15a52e21f8b16c55a1f3b440d64ca`.
Exact amendment CI run
...
passed from `2026-08-27T14:08:49Z` through `2026-08-27T14:29:06Z` for the run
and `2026-08-27T14:08:51Z` through `2026-08-27T14:29:05Z` for the job.

The independently reviewed one-file candidate-governance scope amendment at
`d3984dc0272bc6d36db7e36b1f6708385858a9d3` authorized only bounded V3-01
candidate-state summaries and repair of the malformed I9-to-V3-01 transition.
Its clean local gate ran from `2026-08-27T15:08:34Z` through
`2026-08-27T15:13:42Z`, exited 0, and has credential-free log SHA-256
`85de132acd5a60485bbc3dd220a0d7c0cdc34c98ff73b22dfe8458052c646b17`.
The first setup-only job
[98574962124](https://github.com/jihadismail8/netbox-go/actions/runs/33088596956/job/98574962124)
ran from `2026-08-27T15:35:02Z` through `2026-08-27T15:37:03Z` and stopped
before the repository gate because `sum.golang.org` returned a transient
HTTP/2 `INTERNAL_ERROR`. No repository test failed and no source changed. The
exact-SHA rerun of run
[33088596956](https://github.com/jihadismail8/netbox-go/actions/runs/33088596956)
started at `2026-08-27T15:43:44Z`; job
[98577841871](https://github.com/jihadismail8/netbox-go/actions/runs/33088596956/job/98577841871)
ran from `2026-08-27T15:43:48Z` through `2026-08-27T16:01:00Z`, and the run
completed successfully at `2026-08-27T16:01:01Z`.

Both amendments changed only `docs/increments/CW1-V3-01.md`. They changed no
runtime behavior, test behavior, schema, profile/resource/scenario/traceability
metadata, dependency, toolchain, exclusion, normalizer, tier, parent,
deployment, rewrite, production, or evidence state. The unrelated
`codex-cw1-v2-02-i1-pre-main-rebase-20260823` stash was not applied, changed,
or dropped.

## Implemented boundary

- `internal/platform/readiness` owns a transport-neutral `Checker`, a narrow
  context-aware `Pinger`, and the single public `ErrUnavailable` result.
  `PostgreSQL.Check` performs exactly one `PingContext` call, derives a maximum
  one-second deadline while preserving an earlier caller deadline, and
  collapses nil, typed-nil, cancellation, timeout, and ping failure without
  retaining or exposing the raw cause.
- Production composition obtains the initialized GORM handle's `*sql.DB`,
  creates one checker, and supplies that same checker instance to HTTP and gRPC.
  Missing composition or constructors fail closed; no always-ready fallback,
  cache, background goroutine, retry policy, query, or schema inspection was
  added.
- `GET /health` remains public, process-only, and never probes PostgreSQL. It
  retains the existing `200` JSON shape with `status` `UP` and the current
  hostname. No dedicated `/ping` route was added.
- `GET /ready` checks on every request. A successful ping returns `200` with
  the same `UP` shape; nil, cancelled, timed-out, or failed readiness returns
  `503` with `status` `DOWN` and the same hostname field. No raw dependency
  error, DSN, host, credential, or configuration is returned or logged.
- Standard `grpc.health.v1.Health/Check` with an empty service name uses the
  same checker and maps success to `SERVING` and failure to `NOT_SERVING`, both
  as successful unary gRPC responses. Non-empty service names return
  `codes.NotFound` without probing. `Health/Watch` returns
  `codes.Unimplemented` immediately. No List, streaming-monitoring, public-auth,
  protobuf, or dependency/toolchain surface was added.
- Seven fixed named tests prove the declared checker, HTTP, gRPC, and
  composition boundary. An auxiliary constructor regression proves the HTTP,
  gRPC, and health constructors reject a missing checker. Existing REST
  surface tests receive an explicit ready checker without changing the route
  inventory.
- The backend coverage policy adds only
  `netbox-go/internal/platform/readiness`, retains all prior measured packages
  and the sole reviewed `netbox-go/internal/service` exclusion, and records
  37,876 covered of 291,613 total statements: 12.9884%, above the 12.4001%
  entry floor.

## Changed tested-source files

The tested candidate differs from candidate-scope amendment
`d3984dc0272bc6d36db7e36b1f6708385858a9d3` across exactly 17 regular
mode-`100644` paths, with 642 insertions and 59 deletions:
...
7. `netbox-backend/cmd/netbox_go/initial/createService.go`
8. `netbox-backend/cmd/netbox_go/initial/createService_test.go` — new
9. `netbox-backend/internal/adapters/rest/netbox/router/router.go`
10. `netbox-backend/internal/adapters/rest/netbox/router/router_test.go`
11. `netbox-backend/internal/platform/readiness/readiness.go` — new
12. `netbox-backend/internal/platform/readiness/readiness_test.go` — new
13. `netbox-backend/internal/server/grpc.go`
14. `netbox-backend/internal/server/grpc_test.go`
15. `netbox-backend/internal/server/http.go`
16. `netbox-backend/quality/coverage-baseline.tsv`
17. `netbox-backend/test/contract/rest/surface_test.go`

Three paths are new. No path was deleted, renamed, retargeted, type-changed,
mode-changed, or made executable. Every path is authorized by reviewed packet
items 8 through 25. The six governance paths record only bounded candidate
state; they make no evidence, tier, parent, profile, deployment, rewrite, or
production claim.

## Fixed regression and review boundary

The seven fixed packet-named tests exist once each and passed:

```text
TestPostgreSQLReadinessTracksSuccessLossAndRecovery
TestPostgreSQLReadinessHonorsCallerCancellationAndOneSecondCap
TestRuntimePublicProbesTrackPostgreSQLReadiness
TestRuntimeGRPCHealthTracksPostgreSQLReadiness
TestRuntimeGRPCHealthRejectsNamedServicesWithoutProbing
TestRuntimeGRPCHealthWatchIsUnimplemented
TestRuntimeReadinessConstructionFailsClosedWithoutChecker
```

`TestRuntimeServerConstructorsRejectMissingReadinessChecker` is an auxiliary
affected/race regression, not an eighth fixed packet-named test. Independent
read-only reviews found and verified the resolution of shared-checker
construction coverage, typed-nil fail-closed handling, packet coverage
ownership, candidate-governance scope, amendment provenance, and the fixed-test
versus auxiliary-test wording. No test, comparator, normalizer, security
control, lint rule, coverage floor, generated check, or evidence requirement
was weakened.

## Exact committed focused, affected, and race results

The exact committed named-test replay ran from `2026-08-27T16:02:52Z` through
`2026-08-27T16:02:53Z`, exited 0, and has credential-free log SHA-256
`49e34c276deca48a623c43c36043ee43f444fb09bfd7af50fd74332c2e324794`.
The exact affected-package replay ran from `2026-08-27T16:02:53Z` through
`2026-08-27T16:02:55Z`, exited 0, and has log SHA-256
`ac6d39699948e75e030209d77fe18c43c0bb8e1a605e3055c4c5c7d85abc216c`.
The race-enabled affected-package replay ran from `2026-08-27T16:02:55Z`
through `2026-08-27T16:03:06Z`, exited 0, and has log SHA-256
`22f45548dd5917995288308f346427103c2666a51e91f7834b88f6900febc1e4`.
...
- `internal/server`;
- `cmd/netbox_go/initial`; and
- `test/contract/rest`.

The race replay passed readiness in 1.007 seconds, the router in 10.674
seconds, server in 1.533 seconds, startup composition in 1.537 seconds, and the
REST contract package in 1.536 seconds. The exact-name command reports no
matching test in the REST contract package because that permitted file only
adapts the pre-existing route-inventory test to explicit checker injection;
the seven fixed names pass at their four owning package boundaries.

## Complete L4 real-PostgreSQL regression

The exact committed complete L4 regression ran from
`2026-08-27T16:03:14Z` through `2026-08-27T16:03:49Z`, exited 0, and passed:

| Package                                | Result  |
| -------------------------------------- | ------: |
| `internal/database`                    |  2.325s |
| `internal/adapters/postgres/bootstrap` |  0.037s |
| `internal/adapters/postgres/dcim`      |  3.404s |
| `internal/adapters/postgres/dcim/row`  |  0.300s |
| `internal/adapters/postgres/ipam`      |  1.773s |
| `internal/adapters/postgres/ipam/row`  |  0.386s |
| `internal/adapters/postgres/changelog` |  0.003s |
| `internal/application/dcim`            |  0.005s |
| `internal/application/ipam`            |  0.067s |
| `internal/application/identity`        | 34.534s |
| `cmd/netbox_go_admin`                  |  6.541s |

The credential-free L4 log has SHA-256
`4040262584174d0dc96c99aad48c27995b93bab5a48af0df044874879783c517`.
The run used the existing owned local PostgreSQL test service through an
ephemeral environment-provided DSN. The DSN and password were not written to
the log or this artifact; the wrapper scanned the log for the credential and
`password=` before retaining the hash. The L4 suites own their disposable
schemas. This successful regression does not stop or restart PostgreSQL and
does not substitute for V3-04 real deployment dependency-loss/recovery proof.

## Whole-repository result

The exact committed candidate passed the pinned root repository gate from
`2026-08-27T16:04:01Z` through `2026-08-27T16:09:03Z` with exit 0:

```bash
env \
  GOCACHE=/tmp/go-cache \
  GOLANGCI_LINT_CACHE=/tmp/netbox-v3-candidate-golangci-cache \
...
- zero backend lint issues and all hermetic backend packages under the race
  detector;
- backend coverage at 12.9884% (37,876/291,613), matching the exact candidate
  baseline, across 55 measured packages with one reviewed exclusion;
- 29 frontend files and 179 tests;
- contract inventory at 155 baseline REST, 123 current REST, 179 current gRPC,
  and 13 current Vue entries;
- the unchanged `13/3/17/293` Capability Profile boundary;
- generated consistency for OpenAPI and two contract documents;
- the unchanged `33/86` OpenAPI shape; and
- valid local links across 177 Markdown files.

The credential-free exact committed log has SHA-256
`cdeb7567a77151abfd1e1a8b5889d9a777f7cde2f5e26ecbb3515bf9f01f7333`.
The tested digest, 3,075-entry complete manifest, canonical manifest-output
hash, and 17-path mapping were reproduced after the gate and remained
byte-identical to the candidate commit metadata.

## Independent candidate CI

- Workflow: `repository-gate`.
- Run:
  [33092055202](https://github.com/jihadismail8/netbox-go/actions/runs/33092055202).
- Job `check`:
  [98587191176](https://github.com/jihadismail8/netbox-go/actions/runs/33092055202/job/98587191176).
- Branch: `work/cw1-v3-01-dependency-readiness`.
- Head SHA: `58241d7f87b642e6b7eca279592ad3759a0f5a06`.
- Run start/completion:
  `2026-08-27T16:12:59Z`–`2026-08-27T16:30:00Z`.
- Job start/completion:
  `2026-08-27T16:13:02Z`–`2026-08-27T16:30:00Z`.
- Conclusion: **success**.

This result exercised exact tested source candidate
`58241d7f87b642e6b7eca279592ad3759a0f5a06`, not a merge revision or later
behavior source. Evidence assembly began only after the terminal conclusion
was success.

## Digest-excluded claim local gate

The exact two-path evidence assembly passed the pinned full repository gate
from `2026-08-27T16:33:28Z` through `2026-08-27T16:38:39Z` with exit 0. It
retained zero backend lint issues, 12.9884% backend coverage
(37,876/291,613) across 55 measured packages with the sole reviewed exclusion,
all backend race and coverage checks, 29 frontend files and 179 tests, 96
traceability tests, 219 capability/OpenAPI adversarial tests, the unchanged
`13/3/17/293` profile boundary, the unchanged `33/86` OpenAPI shape, current
contract inventory, generated consistency, and valid local links across 178
Markdown files. Its credential-free log has SHA-256
`80b5b3af15cab932cc0a99693de4b1d24958c8f90af7cb58b3cca0450ed1fbff`.
...
No pinned differential is applicable to these replacement-only operational
probes, and none was run. REST T2 and corresponding gRPC T3 remain unearned.
No browser workflow or deployment-image gate was run or claimed. The complete
L4 regression proves existing real-PostgreSQL suites remain green; it does not
prove the service's public readiness transitions during actual PostgreSQL
stop/start or network loss.

Real deployment success → dependency loss → recovery, Compose orchestration,
streaming health, startup probes, metrics/alerting/runbooks, reconnect/restart,
schema/bootstrap and locking/rollback policy, TLS, graceful shutdown, broader
operability, V3 completion, profile publication, rewrite completion, and
production readiness remain open. Deterministic scripted checker, HTTP, and
gRPC tests do not substitute for V3-04's deployment boundary.

## Gate disposition

- L0–L3: passed for the bounded readiness checker, HTTP adapter, gRPC health
  adapter, startup composition, route-surface regression, seven fixed names,
  and auxiliary constructor proof.
- L4 real PostgreSQL: complete regression passed without skip; this increment
  adds no persistence behavior and makes no deployment-loss claim.
- L5 differential REST: not applicable to the replacement-only operational
  probes and not run; no T2 claim is made.
- L6 gRPC T3: not claimed. The standard health regression is an operational
  adapter proof, not a compatibility-tier promotion.
...
## Digest-excluded evidence boundary

The evidence claim is restricted to exactly two source-v2-excluded paths:

1. `docs/evidence/2026-08-27-core-workflow-v3-dependency-readiness-v0.md`
   — new
2. `docs/evidence/README.md`

Those paths must retain the exact candidate SHA, digest, 3,075-entry complete
manifest, canonical manifest-output hash, 17-path mapping, commands, times,
hashes, candidate-CI provenance, conservative assessment, and residual limits
recorded above. Because both paths are excluded from `source-v2`, their claim
and later receipt must leave the tested source digest, entry count, and
complete manifest byte-identical. Neither path may change runtime behavior,
route, schema, migration, security policy, contract behavior,
resource/scenario/profile/traceability metadata, fixture, comparator,
normalizer, permission, dependency, toolchain, coverage policy, tier, parent,
deployment, rewrite, or production state.
...
`58241d7f87b642e6b7eca279592ad3759a0f5a06`. It commits every owned path,
kind, mode, size, content hash, and symlink target at the 3,075-entry boundary.

```json
{
  "schema_version": 2,
  "digest": "source-v2:sha256:5cb32b753a4ac62544b2db24720b70c89904b0ae24731627e236dcd6c68564e9",
  "files": 3075,
  "entries": [
    {
      "kind": "file",
    ...
    },
    {
      ...
      "path": "AGENTS.md",
      "size": 16602,
      "sha256": "sha256:9c7483e0ac9478ecf7145b386697500eb69bc3621ee921682f9c3ed2033af250"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 28688,
      "sha256": "sha256:ead2c107e579319014ad721e41d5b06dbd9c4a57e354a9072389cb36a828022e"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 95342,
      "sha256": "sha256:ee1e909b19870ca1cd5c8cd680d0416a5ac612dc2e0184c20cbd57d5fb5749fb"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "docs/STATUS.md",
      "size": 34602,
      "sha256": "sha256:fdd669274d8d002e146ea4a102f9f0b9161a194d0df3ba202a46868de000bfd8"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 25478,
      "sha256": "sha256:67924ded8c26113862b5a7b234f3fb2e867e432d31eca347a7ec2b64e4c7f106"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 34706,
      "sha256": "sha256:ee165f1ea1c064b23accb94d5814d630d896e34a3cd19b6d6936d10c1c9b0006"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "docs/increments/CW1-V3-01.md",
      "size": 21106,
      "sha256": "sha256:0432893c3f7d7318222a32128feac8445dd1563c56293a82b094f32514652362"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 13158,
      "sha256": "sha256:a980529287e7dc5d891c6a550d78e0ca52be19d4d5aa75233d8de66e20eaa18c"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 4366,
      "sha256": "sha256:61d09321c3f9fcfe4ba809e97c75ba6f7e06d16e9fda6af4d7ff94d112ff5ce2"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "netbox-backend/cmd/netbox_go/initial/createService_test.go",
      "size": 2046,
      "sha256": "sha256:6ac728b11fd9b59cfde1bde7b8ae6fc58f4fc2a658c28bcfdde4b7852e20c25e"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 5502,
      "sha256": "sha256:46c25b6560ccfa4dd33481515cc8aef215f1da766b6aebf49315e85dc268b167"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 23779,
      "sha256": "sha256:4ccf3e85673cf673a563fa367ae390cb20e752601a9fca309215cb5dcff897ab"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "netbox-backend/internal/platform/readiness/readiness.go",
      "size": 1920,
      "sha256": "sha256:7d4b2c922aef971a216e58ef9fd9212f8dc1477ef90d51399b627d820057bcf6"
    },
    {
      "kind": "file",
      "mode": "100644",
      "path": "netbox-backend/internal/platform/readiness/readiness_test.go",
      "size": 5130,
      "sha256": "sha256:b4cb5cd7b63fa83d2080816b1e3c9498eb2ba3330ce1ad644a31dae64646eeb8"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 10839,
      "sha256": "sha256:312c633b514b283896bf075134f1b8e6d2de5baf11e9589e5b4e67d1ba2a961f"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 3898,
      "sha256": "sha256:8f782b7d74be37d27042d0b4877917cddb81adb0292a86cc663015340f94e389"
    },
    {
      "kind": "file",
      "mode": "100644",
      ...
      "size": 3739,
      "sha256": "sha256:060fee5d734ff9758d124ea316a0b973d667c885ed0ae504c05066cb385fe592"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 2565,
      "sha256": "sha256:d51495adda99a844cdfc928df300f35340697f81ce55a69775e349b4aa5af710"
    },
    {
      "kind": "file",
      "mode": "100644",
    ...
    },
    {
      ...
      "size": 2353,
      "sha256": "sha256:ddfcfcad6a2e75cb4b06825b4c4f029c22d9f40f851c1704ee2746ae7eb0147d"
    },
    {
      "kind": "file",
      "mode": "100644",
...
## Exact candidate path mapping

The block below is the complete canonical 17-path mapping from the final
reviewed amendment to the tested implementation candidate. Its raw-byte
SHA-256 is `1670586bb66e5caa1fb5117ecb4ccc342e2ad90d4782a6bd869196f7dd945dea`.

```json
{
  "schema_version": 1,
  "base_revision": "d3984dc0272bc6d36db7e36b1f6708385858a9d3",
  "source_digest": "source-v2:sha256:5cb32b753a4ac62544b2db24720b70c89904b0ae24731627e236dcd6c68564e9",
  "source_files": 3075,
  "paths": [
    {
      "kind": "file",
...
manifest and this source-v2-excluded evidence-claim worktree. It proves the
two evidence paths add no owned source entry or content change. Its raw-byte
SHA-256 is recorded in the evidence-claim gate provenance.

```json
{
  "schema_version": 1,
  "tested_digest": "source-v2:sha256:5cb32b753a4ac62544b2db24720b70c89904b0ae24731627e236dcd6c68564e9",
  "attestation_digest": "source-v2:sha256:5cb32b753a4ac62544b2db24720b70c89904b0ae24731627e236dcd6c68564e9",
  "tested_files": 3075,
  "attestation_files": 3075,
