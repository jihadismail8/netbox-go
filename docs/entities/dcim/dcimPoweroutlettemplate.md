...
> Module: `dcim` | Table: `dcim_poweroutlettemplate` | Python class: `Poweroutlettemplate` | File: `dcim/models/device_component_templates.py`

**Inheritance:** `ComponentTemplateModel <- ChangeLoggedModel <- TrackingModelMixin`

**REST URL:** `/api/dcim/power-outlet-templates/`

## Implementation Status

- [ ] Go model (`internal/model/dcimPoweroutlettemplate.go`)
- [ ] GORM mapping verified
- [ ] Column whitelist complete
- [ ] Proto definition (`api/netbox_go/v1/dcimPoweroutlettemplate.proto`)
- [ ] Proto generated code
- [ ] DAO layer (`internal/dao/dcimPoweroutlettemplate.go`)
- [ ] DAO unit tests
- [ ] Cache layer
- [ ] Service layer
- [ ] Handler layer
...
|-------|---------------|-----------|------|--------------|
| `device_type` | [DeviceType](./dcimDevicetype.md) | `CASCADE` | No | `poweroutlettemplates` |

### Foreign Keys (additional)

| Field | Related Model | on_delete | null | related_name |
|-------|---------------|-----------|------|--------------|
| `power_port` | [PowerPortTemplate](./dcimPowerporttemplate.md) | `SET_NULL` | Yes | `poweroutlets` |
...
- [DeviceType](./dcimDevicetype.md) counter cache `power_outlet_template_count`
