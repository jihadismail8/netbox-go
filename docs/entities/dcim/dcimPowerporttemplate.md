...
> Module: `dcim` | Table: `dcim_powerporttemplate` | Python class: `Powerporttemplate` | File: `dcim/models/device_component_templates.py`

**Inheritance:** `ComponentTemplateModel <- ChangeLoggedModel <- TrackingModelMixin`

**REST URL:** `/api/dcim/power-port-templates/`

## Implementation Status

- [ ] Go model (`internal/model/dcimPowerporttemplate.go`)
- [ ] GORM mapping verified
- [ ] Column whitelist complete
- [ ] Proto definition (`api/netbox_go/v1/dcimPowerporttemplate.proto`)
- [ ] Proto generated code
- [ ] DAO layer (`internal/dao/dcimPowerporttemplate.go`)
- [ ] DAO unit tests
- [ ] Cache layer
- [ ] Service layer
- [ ] Handler layer
...
|-------|---------------|-----------|------|--------------|
| `device_type` | [DeviceType](./dcimDevicetype.md) | `CASCADE` | No | `powerporttemplates` |
...
- [PowerOutletTemplate](./dcimPoweroutlettemplate.md) via `power_port` (FK)
- [DeviceType](./dcimDevicetype.md) counter cache `power_port_template_count`
