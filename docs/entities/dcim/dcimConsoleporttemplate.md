...
> Module: `dcim` | Table: `dcim_consoleporttemplate` | Python class: `Consoleporttemplate` | File: `dcim/models/device_component_templates.py`

**Inheritance:** `ComponentTemplateModel <- ChangeLoggedModel <- TrackingModelMixin`

**REST URL:** `/api/dcim/console-port-templates/`

## Implementation Status

- [ ] Go model (`internal/model/dcimConsoleporttemplate.go`)
- [ ] GORM mapping verified
- [ ] Column whitelist complete
- [ ] Proto definition (`api/netbox_go/v1/dcimConsoleporttemplate.proto`)
- [ ] Proto generated code
- [ ] DAO layer (`internal/dao/dcimConsoleporttemplate.go`)
- [ ] DAO unit tests
- [ ] Cache layer
- [ ] Service layer
- [ ] Handler layer
...
|-------|---------------|-----------|------|--------------|
| `device_type` | [DeviceType](./dcimDevicetype.md) | `CASCADE` | No | `consoleporttemplates` |
...
- [DeviceType](./dcimDevicetype.md) counter cache `console_port_template_count`
