...
> Module: `dcim` | Table: `dcim_interfacetemplate` | Python class: `Interfacetemplate` | File: `dcim/models/device_component_templates.py`

**Inheritance:** `ComponentTemplateModel <- ChangeLoggedModel <- TrackingModelMixin`

**REST URL:** `/api/dcim/interface-templates/`

## Implementation Status

- [ ] Go model (`internal/model/dcimInterfacetemplate.go`)
- [ ] GORM mapping verified
- [ ] Column whitelist complete
- [ ] Proto definition (`api/netbox_go/v1/dcimInterfacetemplate.proto`)
- [ ] Proto generated code
- [ ] DAO layer (`internal/dao/dcimInterfacetemplate.go`)
- [ ] DAO unit tests
- [ ] Cache layer
- [ ] Service layer
- [ ] Handler layer
...
|-------|---------------|-----------|------|--------------|
| `device_type` | [DeviceType](./dcimDevicetype.md) | `CASCADE` | No | `interfacetemplates` |
...
- [DeviceType](./dcimDevicetype.md) counter cache `interface_template_count`
