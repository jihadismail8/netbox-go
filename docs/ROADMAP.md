...
| 3    | Traceable differential/parity proof | `CW1-V2-*`, `CW1-V4-*`                  | V2-01/I1–I7 done; InterfaceTemplate I8 done claim conditional; parent/T2/T3 open |
...
evidence-claim, and pre-acceptance receipt exact-SHA CI boundaries are green.
The project owner's acceptance of only this bounded result was recorded at
`2026-08-26T02:27:06Z`; `done` becomes effective when the current
...
| `CW1-V2-02`         | `in-progress` | Retain owner-accepted InterfaceTemplate I8 closeout | Accepted V2-01 and current `CW1-G00`   |
...
- [`CW1-V2-02-I8`](increments/CW1-V2-02-I8.md) owns only InterfaceTemplate
  ...
  owner accepted only this bounded result at `2026-08-26T02:27:06Z`; bounded
  `done` is conditional on the exact owner-accepted closeout claim passing
  repository CI, after which the excluded two-path receipt must also pass. No
  later child is claimed.
