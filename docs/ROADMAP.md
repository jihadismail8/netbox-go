...
| 3    | Traceable differential/parity proof | `CW1-V2-*`, `CW1-V4-*`                  | V2-01/I1–I7 done; InterfaceTemplate I8 active; parent/T2/T3 open          |
...
[`CW1-V2-02-I8`](increments/CW1-V2-02-I8.md) is the active reviewed increment.
It owns only InterfaceTemplate `device_type`, `name`, `label`, `type`,
`enabled`, `mgmt_only`, and `description` common create/PUT/PATCH presence
across operation-specific contracts, shared typed semantics, PostgreSQL
durability, and Vue dirty-field handling. It exercises existing DeviceType-owner
containment without closing owner immutability and excludes uniqueness,
ModuleType ownership, bridge behavior, Device
instantiation/snapshot/rollback, non-retroactivity, deletion, list/query,
full CRUD, every tier and consumer, this parent, the profile, and later
children.
...
| `CW1-V2-02`         | `in-progress` | Implement reviewed InterfaceTemplate scalar child I8 | Accepted V2-01 and current `CW1-G00`   |
...
| `CW1-V2-02-I8`      | `in-progress` | Implement InterfaceTemplate scalar write presence   | Done I7 and current `CW1-G00`          |
...
- [`CW1-V2-02-I8`](increments/CW1-V2-02-I8.md) owns only InterfaceTemplate
  ...
  parent, and every traceability consumer remain open. No implementation
  evidence exists at entry.
