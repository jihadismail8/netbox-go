...
| 3    | Traceable differential/parity proof | `CW1-V2-*`, `CW1-V4-*`                  | V2-01/I1–I6 done; DeviceType I7 done claim conditional; parent/T2/T3 open       |
...
| `CW1-V2-02`         | `in-progress` | Retain owner-accepted DeviceType I7 closeout         | Accepted V2-01 and current `CW1-G00`   |
...
The I7 asterisk records that owner-accepted `done` becomes effective only
...
- [`CW1-V2-02-I7`](increments/CW1-V2-02-I7.md) owns only DeviceType
  ...
  accepted only this bounded result at `2026-08-25T14:12:13Z`; bounded `done`
