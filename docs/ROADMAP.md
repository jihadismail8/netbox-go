...
| 3    | Traceable differential/parity proof | `CW1-V2-*`, `CW1-V4-*`                  | V2-01/I1–I6 done; DeviceType I7 active; parent/T2/T3 open                       |
...
[`CW1-V2-02-I7`](increments/CW1-V2-02-I7.md) is the active reviewed increment.
It owns only DeviceType `manufacturer`, `model`, `slug`, `part_number`,
`u_height`, `exclude_from_utilization`, `is_full_depth`, `airflow`,
`description`, and `comments` common create/PUT/PATCH presence across
operation-specific contracts, shared typed semantics, PostgreSQL durability,
and Vue dirty-field handling. It excludes uniqueness, positioned-Device height
transitions, deletion/cascades, list/query behavior, full CRUD, every tier and
consumer, this parent, the profile, and later children.
...
| `CW1-V2-02`         | `in-progress` | Implement reviewed DeviceType scalar child I7       | Accepted V2-01 and current `CW1-G00`   |
...
| `CW1-V2-02-I7`      | `in-progress` | Implement bounded DeviceType scalar write presence  | Done I6 and current `CW1-G00`          |
...
- [`CW1-V2-02-I7`](increments/CW1-V2-02-I7.md) owns only DeviceType
  ...
  every traceability consumer remain open. No evidence exists at entry.
